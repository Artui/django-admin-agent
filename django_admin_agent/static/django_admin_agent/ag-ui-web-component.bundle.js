...
`).trim()}var qw=1500;function nc(t,e){if(dp(t)!==null)return;let n=Ps(t,e.strings),r=e.text;r!==void 0&&n.appendChild(Ww(e.strings,r,e.html)),e.onFeedback!==void 0&&n.append(cp("up",e.strings.feedbackUp,e.onFeedback),cp("down",e.strings.feedbackDown,e.onFeedback))}function Ps(t,e){let n=dp(t);if(n!==null)return n;let r=document.createElement("div");return r.className="message-actions",r.setAttribute("part","message-actions"),r.setAttribute("role","group"),r.setAttribute("aria-label",e.messageActions),t.after(r),r}function dp(t){let e=t.nextElementSibling;return e?.classList.contains("message-actions")===!0?e:null}function Ds(t,e,n){let r=document.createElement("button");r.type="button",r.className=`message-action message-action--${t}`,r.setAttribute("part",`message-action message-action-${t}`),tc(r,e);let o=document.createElement("span");return o.className="message-action-icon",o.setAttribute("part",`message-action-icon message-action-icon-${t}`),o.setAttribute("aria-hidden","true"),o.innerHTML=n,r.appendChild(o),r}function tc(t,e){t.title=e,t.setAttribute("aria-label",e),t.dataset.tooltip=e}function Ww(t,e,n){let r=Ds("copy",t.copyMessage,fd);return r.addEventListener("click",()=>{Xw(e(),n?.()).then(o=>{Yw(r,o?t.copied:t.copyFailed,t.copyMessage)})}),r}async function Xw(t,e){let n=navigator.clipboard;if(n===void 0)return!1;if(e!==void 0&&typeof ClipboardItem=="function")try{return await n.write([new ClipboardItem({"text/plain":new Blob([t],{type:"text/plain"}),"text/html":new Blob([e],{type:"text/html"})})]),!0}catch{}try{return await n.writeText(t),!0}catch{return!1}}function cp(t,e,n){let r=Ds(t==="up"?"up":"down",e,t==="up"?gd:vd);return r.addEventListener("click",()=>{let o=r.getAttribute("aria-pressed")==="true";r.setAttribute("aria-pressed",o?"false":"true"),n(t)}),r.setAttribute("aria-pressed","false"),r}function Yw(t,e,n){tc(t,e),t.classList.add("message-action--confirmed"),setTimeout(()=>{tc(t,n),t.classList.remove("message-action--confirmed")},qw)}var Us=class{#e;#t=null;constructor(e){this.#e=e}forget(){this.#t=null}attach(e,n={}){let r=this.#o(),o=r.has(jt.COPY),i=n.rateable!==!1&&r.has(jt.FEEDBACK);(o||i)&&nc(e,{strings:this.#e.strings(),...o?{text:()=>Ls(e).text,html:()=>Ls(e).html}:{},...i?{onFeedback:s=>{this.#e.element.dispatchEvent(new CustomEvent(ka,{detail:{content:Ls(e).text,rating:s},bubbles:!0,composed:!0}))}}:{}}),r.has(jt.RETRY)&&this.#n(Ps(e,this.#e.strings()))}#n(e){this.#t?.querySelector(".message-action--retry")?.remove();let n=Ds("retry",this.#e.strings().retryMessage,md);n.addEventListener("click",()=>{this.#e.retry()}),e.prepend(n),this.#t=e}#o(){let e=this.#e.element.getAttribute("data-message-actions");return e===null?new Set([jt.COPY,jt.RETRY]):new Set(rr(e))}};function up(t,e){(e==null||e>t.length)&&(e=t.length);for(var n=0,r=Array(e);n<e;n++)r[n]=t[n];return r}function Kw(t){if(Array.isArray(t))return t}function Zw(t,e){var n=t==null?null:typeof Symbol<"u"&&t[Symbol.iterator]||t["@@iterator"];if(n!=null){var r,o,i,s,a=[],l=!0,c=!1;try{if(i=(n=n.call(t)).next,e!==0)for(;!(l=(r=i.call(n)).done)&&(a.push(r.value),a.length!==e);l=!0);}catch(u){c=!0,o=u}finally{try{if(!l&&n.return!=null&&(s=n.return(),Object(s)!==s))return}finally{if(c)throw o}}return a}}function Qw(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function Jw(t,e){return Kw(t)||Zw(t,e)||ex(t,e)||Qw()}function ex(t,e){if(t){if(typeof t=="string")return up(t,e);var n={}.toString.call(t).slice(8,-1);return n==="Object"&&t.constructor&&(n=t.constructor.name),n==="Map"||n==="Set"?Array.from(t):n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?up(t,e):void 0}}var Ap=Object.entries,hp=Object.setPrototypeOf,tx=Object.isFrozen,nx=Object.getPrototypeOf,rx=Object.getOwnPropertyDescriptor,Ee=Object.freeze,Se=Object.seal,ir=Object.create,kp=typeof Reflect<"u"&&Reflect,cc=kp.apply,dc=kp.construct;Ee||(Ee=function(e){return e});Se||(Se=function(e){return e});cc||(cc=function(e,n){for(var r=arguments.length,o=new Array(r>2?r-2:0),i=2;i<r;i++)o[i-2]=arguments[i];return e.apply(n,o)});dc||(dc=function(e){for(var n=arguments.length,r=new Array(n>1?n-1:0),o=1;o<n;o++)r[o-1]=arguments[o];return new e(...r)});var xn=we(Array.prototype.forEach),ox=we(Array.prototype.lastIndexOf),pp=we(Array.prototype.pop),qr=we(Array.prototype.push),ix=we(Array.prototype.splice),sr=Array.isArray,Yr=we(String.prototype.toLowerCase),rc=we(String.prototype.toString),fp=we(String.prototype.match),Wr=we(String.prototype.replace),mp=we(String.prototype.indexOf),sx=we(String.prototype.trim),ax=we(Number.prototype.toString),lx=we(Boolean.prototype.toString),gp=typeof BigInt>"u"?null:we(BigInt.prototype.toString),vp=typeof Symbol>"u"?null:we(Symbol.prototype.toString),Fe=we(Object.prototype.hasOwnProperty),Xr=we(Object.prototype.toString),Ne=we(RegExp.prototype.test),wn=cx(TypeError);function we(t){return function(e){e instanceof RegExp&&(e.lastIndex=0);for(var n=arguments.length,r=new Array(n>1?n-1:0),o=1;o<n;o++)r[o-1]=arguments[o];return cc(t,e,r)}}function cx(t){return function(){for(var e=arguments.length,n=new Array(e),r=0;r<e;r++)n[r]=arguments[r];return dc(t,n)}}function ee(t,e){let n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Yr;if(hp&&hp(t,null),!sr(e))return t;let r=e.length;for(;r--;){let o=e[r];if(typeof o=="string"){let i=n(o);i!==o&&(tx(e)||(e[r]=i),o=i)}t[o]=!0}return t}function dx(t){for(let e=0;e<t.length;e++)Fe(t,e)||(t[e]=null);return t}function We(t){let e=ir(null);for(let r of Ap(t)){var n=Jw(r,2);let o=n[0],i=n[1];Fe(t,o)&&(sr(i)?e[o]=dx(i):i&&typeof i=="object"&&i.constructor===Object?e[o]=We(i):e[o]=i)}return e}function ux(t){switch(typeof t){case"string":return t;case"number":return ax(t);case"boolean":return lx(t);case"bigint":return gp?gp(t):"0";case"symbol":return vp?vp(t):"Symbol()";case"undefined":return Xr(t);case"function":case"object":{if(t===null)return Xr(t);let e=t,n=it(e,"toString");if(typeof n=="function"){let r=n(e);return typeof r=="string"?r:Xr(r)}return Xr(t)}default:return Xr(t)}}function it(t,e){for(;t!==null;){let r=rx(t,e);if(r){if(r.get)return we(r.get);if(typeof r.value=="function")return we(r.value)}t=nx(t)}function n(){return null}return n}function hx(t){try{return Ne(t,""),!0}catch{return!1}}var bp=Ee(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),oc=Ee(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),ic=Ee(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),px=Ee(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),sc=Ee(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),fx=Ee(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),yp=Ee(["#text"]),wp=Ee(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),ac=Ee(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dominant-baseline","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","pointer-events","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-orientation","text-rendering","textlength","type","u1","u2","unicode","values","vector-effect","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),xp=Ee(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Hs=Ee(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),mx=Se(/{{[\w\W]*|^[\w\W]*}}/g),gx=Se(/<%[\w\W]*|^[\w\W]*%>/g),vx=Se(/\${[\w\W]*/g),bx=Se(/^data-[\-\w.\u00B7-\uFFFF]+$/),yx=Se(/^aria-[\-\w]+$/),Ep=Se(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),wx=Se(/^(?:\w+script|data):/i),xx=Se(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Ex=Se(/^html$/i),Tx=Se(/^[a-z][.\w]*(-[.\w]+)+$/i),Tp=Se(/<[/\w!]/g),_p=Se(/<[/\w]/g),_x=Se(/<\/no(script|embed|frames)/i),Sx=Se(/\/>/i),qe={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,processingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},Rp=["style","script","xmp","iframe","noembed","noframes","plaintext","noscript"],Ax=Ee(ee({},Rp)),kx=(function(){let t={};return xn(Rp,e=>{t[e]=Se(new RegExp("</"+e+"(?=[\\t\\n\\f\\r />])","i"))}),Ee(t)})(),Rx=function(){return typeof window>"u"?null:window},Ix=function(e,n){if(typeof e!="object"||typeof e.createPolicy!="function")return null;let r=null,o="data-tt-policy-suffix";n&&n.hasAttribute(o)&&(r=n.getAttribute(o));let i="dompurify"+(r?"#"+r:"");try{return e.createPolicy(i,{createHTML(s){return s},createScriptURL(s){return s}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},Sp=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}},Gt=function(e,n,r,o){return Fe(e,n)&&sr(e[n])?ee(o.base?We(o.base):{},e[n],o.transform):r},lc=function(e,n,r){let o=Fe(e,n)?e[n]:void 0;return o&&typeof o=="object"?We(o):r()};function Ip(){let t=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Rx(),e=R=>Ip(R);if(e.version="3.4.14",e.removed=[],!t||!t.document||t.document.nodeType!==qe.document||!t.Element)return e.isSupported=!1,e;let n=t.document,r=n,o=r.currentScript;t.DocumentFragment;let i=t.HTMLTemplateElement,s=t.Node,a=t.Element,l=t.NodeFilter,c=t.NamedNodeMap;c===void 0&&(t.NamedNodeMap||t.MozNamedAttrMap),t.HTMLFormElement;let u=t.DOMParser,m=t.trustedTypes,w=a.prototype,p=it(w,"cloneNode"),h=it(w,"remove"),v=it(w,"nextSibling"),x=it(w,"childNodes"),S=it(w,"parentNode"),_=it(w,"shadowRoot"),L=it(w,"attributes"),z=s&&s.prototype?it(s.prototype,"nodeType"):null,b=s&&s.prototype?it(s.prototype,"nodeName"):null,A=s&&s.prototype?it(s.prototype,"ownerDocument"):null,E=function(f){return z?z(f):f.nodeType},I=function(f){return b?b(f):f.nodeName};if(typeof i=="function"){let R=n.createElement("template");R.content&&R.content.ownerDocument&&(n=R.content.ownerDocument)}let B,ce="",Te,Ye=!1,dr=0,Ic=function(){if(dr>0)throw wn('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},Sn=function(f){Ic(),dr++;try{return B.createHTML(f)}finally{dr--}},pf=function(f){Ic(),dr++;try{return B.createScriptURL(f)}finally{dr--}},ff=function(){return Ye||(Te=Ix(m,o),Ye=!0),Te},ao=n,na=ao.implementation,Cc=ao.createNodeIterator,mf=ao.createDocumentFragment,gf=ao.getElementsByTagName,vf=r.importNode,ue=Sp();e.isSupported=typeof Ap=="function"&&typeof S=="function"&&na&&na.createHTMLDocument!==void 0;let bf=mx,yf=gx,wf=vx,xf=bx,Ef=yx,Tf=wx,Nc=xx,_f=Tx,Oc=Ep,he=null,ra=ee({},[...bp,...oc,...ic,...sc,...yp]),pe=null,oa=ee({},[...wp,...ac,...xp,...Hs]),ct=Object.seal(ir(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),ur=null,Mc=null,kt=Object.seal(ir(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}})),Lc=!0,ia=!0,Pc=!1,Dc=!0,Rt=!1,Ft=!0,$t=!1,sa=!1,lo=null,co=null,aa=!1,An=!1,uo=!1,ho=!1,Uc=!0,Hc=!1,Gc="user-content-",la=!0,ca=!1,kn={},Rn=null,zc=ee({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]),Fc=null,$c=ee({},["audio","video","img","source","image","track"]),Bc=null,jc=ee({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),po="http://www.w3.org/1998/Math/MathML",fo="http://www.w3.org/2000/svg",dt="http://www.w3.org/1999/xhtml",In=dt,da=!1,ua=null,Sf=ee({},[po,fo,dt],rc),Vc=Ee(["mi","mo","mn","ms","mtext"]),ha=ee({},Vc),qc=Ee(["annotation-xml"]),pa=ee({},qc),Af=ee({},["title","style","font","a","script"]),hr=null,kf=["application/xhtml+xml","text/html"],Rf="text/html",ve=null,Cn=null,If=n.createElement("form"),Wc=function(f){return f instanceof RegExp||f instanceof Function},fa=function(){let f=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Cn&&Cn===f)return;(!f||typeof f!="object")&&(f={}),f=We(f),hr=kf.indexOf(f.PARSER_MEDIA_TYPE)===-1?Rf:f.PARSER_MEDIA_TYPE,ve=hr==="application/xhtml+xml"?rc:Yr,he=Gt(f,"ALLOWED_TAGS",ra,{transform:ve}),pe=Gt(f,"ALLOWED_ATTR",oa,{transform:ve}),ua=Gt(f,"ALLOWED_NAMESPACES",Sf,{transform:rc}),Bc=Gt(f,"ADD_URI_SAFE_ATTR",jc,{transform:ve,base:jc}),Fc=Gt(f,"ADD_DATA_URI_TAGS",$c,{transform:ve,base:$c}),Rn=Gt(f,"FORBID_CONTENTS",zc,{transform:ve}),ur=Gt(f,"FORBID_TAGS",We({}),{transform:ve}),Mc=Gt(f,"FORBID_ATTR",We({}),{transform:ve}),kn=Fe(f,"USE_PROFILES")?f.USE_PROFILES&&typeof f.USE_PROFILES=="object"?We(f.USE_PROFILES):f.USE_PROFILES:!1,Lc=f.ALLOW_ARIA_ATTR!==!1,ia=f.ALLOW_DATA_ATTR!==!1,Pc=f.ALLOW_UNKNOWN_PROTOCOLS||!1,Dc=f.ALLOW_SELF_CLOSE_IN_ATTR!==!1,Rt=f.SAFE_FOR_TEMPLATES||!1,Ft=f.SAFE_FOR_XML!==!1,$t=f.WHOLE_DOCUMENT||!1,An=f.RETURN_DOM||!1,uo=f.RETURN_DOM_FRAGMENT||!1,ho=f.RETURN_TRUSTED_TYPE||!1,aa=f.FORCE_BODY||!1,Uc=f.SANITIZE_DOM!==!1,Hc=f.SANITIZE_NAMED_PROPS||!1,la=f.KEEP_CONTENT!==!1,ca=f.IN_PLACE||!1,Oc=hx(f.ALLOWED_URI_REGEXP)?f.ALLOWED_URI_REGEXP:Ep,In=typeof f.NAMESPACE=="string"?f.NAMESPACE:dt,ha=lc(f,"MATHML_TEXT_INTEGRATION_POINTS",()=>ee({},Vc)),pa=lc(f,"HTML_INTEGRATION_POINTS",()=>ee({},qc));let y=lc(f,"CUSTOM_ELEMENT_HANDLING",()=>ir(null));if(ct=ir(null),Fe(y,"tagNameCheck")&&Wc(y.tagNameCheck)&&(ct.tagNameCheck=y.tagNameCheck),Fe(y,"attributeNameCheck")&&Wc(y.attributeNameCheck)&&(ct.attributeNameCheck=y.attributeNameCheck),Fe(y,"allowCustomizedBuiltInElements")&&typeof y.allowCustomizedBuiltInElements=="boolean"&&(ct.allowCustomizedBuiltInElements=y.allowCustomizedBuiltInElements),Se(ct),Rt&&(ia=!1),uo&&(An=!0),kn&&(he=ee({},yp),pe=ir(null),kn.html===!0&&(ee(he,bp),ee(pe,wp)),kn.svg===!0&&(ee(he,oc),ee(pe,ac),ee(pe,Hs)),kn.svgFilters===!0&&(ee(he,ic),ee(pe,ac),ee(pe,Hs)),kn.mathMl===!0&&(ee(he,sc),ee(pe,xp),ee(pe,Hs))),kt.tagCheck=null,kt.attributeCheck=null,Fe(f,"ADD_TAGS")&&(typeof f.ADD_TAGS=="function"?kt.tagCheck=f.ADD_TAGS:sr(f.ADD_TAGS)&&(he===ra&&(he=We(he)),ee(he,f.ADD_TAGS,ve))),Fe(f,"ADD_ATTR")&&(typeof f.ADD_ATTR=="function"?kt.attributeCheck=f.ADD_ATTR:sr(f.ADD_ATTR)&&(pe===oa&&(pe=We(pe)),ee(pe,f.ADD_ATTR,ve))),Fe(f,"ADD_FORBID_CONTENTS")&&sr(f.ADD_FORBID_CONTENTS)&&(Rn===zc&&(Rn=We(Rn)),ee(Rn,f.ADD_FORBID_CONTENTS,ve)),la&&(he["#text"]=!0),$t&&ee(he,["html","head","body"]),he.table&&(ee(he,["tbody"]),delete ur.tbody),f.TRUSTED_TYPES_POLICY){if(typeof f.TRUSTED_TYPES_POLICY.createHTML!="function")throw wn('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof f.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw wn('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');let T=B;B=f.TRUSTED_TYPES_POLICY;try{ce=Sn("")}catch(O){throw B=T,O}}else f.TRUSTED_TYPES_POLICY===null?(B=void 0,ce=""):(B===void 0&&(B=ff()),B&&typeof ce=="string"&&(ce=Sn("")));Ee&&Ee(f),Cn=f},Xc=ee({},[...oc,...ic,...px]),Yc=ee({},[...sc,...fx]),Cf=function(f,y,T){return y.namespaceURI===dt?f==="svg":y.namespaceURI===po?f==="svg"&&(T==="annotation-xml"||ha[T]):!!Xc[f]},Nf=function(f,y,T){return y.namespaceURI===dt?f==="math":y.namespaceURI===fo?f==="math"&&pa[T]:!!Yc[f]},Of=function(f,y,T){return y.namespaceURI===fo&&!pa[T]||y.namespaceURI===po&&!ha[T]?!1:!Yc[f]&&(Af[f]||!Xc[f])},Mf=function(f){let y=S(f);(!y||!y.tagName)&&(y={namespaceURI:In,tagName:"template"});let T=Yr(f.tagName),O=Yr(y.tagName);return ua[f.namespaceURI]?f.namespaceURI===fo?Cf(T,y,O):f.namespaceURI===po?Nf(T,y,O):f.namespaceURI===dt?Of(T,y,O):!!(hr==="application/xhtml+xml"&&ua[f.namespaceURI]):!1},It=function(f){qr(e.removed,{element:f});try{S(f).removeChild(f)}catch{if(h(f),!S(f))throw wn("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},Kc=function(f,y,T){try{f.removeAttributeNode(y)}catch{try{f.removeAttribute(T)}catch{}}},mo=function(f){go(f);let y=x(f);if(y){let O=[];xn(y,H=>{qr(O,H)}),xn(O,H=>{try{h(H)}catch{}})}let T=L(f);if(T)for(let O=T.length-1;O>=0;--O){let H=T[O],j=H&&H.name;typeof j=="string"&&Kc(f,H,j)}},Bt=function(f,y,T){if(!T)try{T=y.getAttributeNode(f)}catch{T=null}qr(e.removed,{attribute:T||null,from:y});try{T?y.removeAttributeNode(T):y.removeAttribute(f)}catch{try{y.removeAttribute(f)}catch{}}if(f==="is")if(An||uo)try{It(y)}catch{}else try{y.setAttribute(f,"")}catch{}},Lf=function(f){let y=L(f);if(y)for(let T=y.length-1;T>=0;--T){let O=y[T],H=O&&O.name;typeof H!="string"||pe[ve(H)]||Kc(f,O,H)}},go=function(f){let y=[f];for(;y.length>0;){let T=y.pop();E(T)===qe.element&&Lf(T);let H=x(T);if(H)for(let j=H.length-1;j>=0;--j)y.push(H[j])}},Zc=function(f,y){return Ft?f==="patchsrc"?!0:f==="for"&&y!=="label"&&y!=="output":!1},Pf=function(f){if(!Ft)return;let y=[f];for(;y.length>0;){let T=y.pop(),O=E(T);if(O===qe.processingInstruction||O===qe.comment&&Ne(_p,T.data)){try{h(T)}catch{}continue}if(O===qe.element){let j=T,se=ve(I(T));try{j.hasAttribute&&j.hasAttribute("patchsrc")&&j.removeAttribute("patchsrc"),j.hasAttribute&&j.hasAttribute("for")&&Zc("for",se)&&j.removeAttribute("for")}catch{}}let H=x(T);if(H)for(let j=H.length-1;j>=0;--j)y.push(H[j])}},Qc=function(f){let y=null,T=null;if(aa)f="<remove></remove>"+f;else{let j=fp(f,/^[\r\n\t ]+/);T=j&&j[0]}hr==="application/xhtml+xml"&&In===dt&&(f='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+f+"</body></html>");let O=B?Sn(f):f;if(In===dt)try{y=new u().parseFromString(O,hr)}catch{}if(!y||!y.documentElement){y=na.createDocument(In,"template",null);try{y.documentElement.innerHTML=da?ce:O}catch{}}let H=y.body||y.documentElement;return f&&T&&H.insertBefore(n.createTextNode(T),H.childNodes[0]||null),In===dt?gf.call(y,$t?"html":"body")[0]:$t?y.documentElement:H},Jc=function(f){let y=A?A(f):f.ownerDocument;return Cc.call(y||f,f,l.SHOW_ELEMENT|l.SHOW_COMMENT|l.SHOW_TEXT|l.SHOW_PROCESSING_INSTRUCTION|l.SHOW_CDATA_SECTION,null)},vo=function(f){return f=Wr(f,bf," "),f=Wr(f,yf," "),f=Wr(f,wf," "),f},ma=function(f){var y;f.normalize();let T=A?A(f):f.ownerDocument,O=Cc.call(T||f,f,l.SHOW_TEXT|l.SHOW_COMMENT|l.SHOW_CDATA_SECTION|l.SHOW_PROCESSING_INSTRUCTION,null),H=O.nextNode();for(;H;)H.data=vo(H.data),H=O.nextNode();let j=(y=f.querySelectorAll)===null||y===void 0?void 0:y.call(f,"template");j&&xn(j,se=>{Nn(se.content)&&ma(se.content)})},bo=function(f){let y=b?b(f):null;return typeof y!="string"||ve(y)!=="form"?!1:typeof f.nodeName!="string"||typeof f.textContent!="string"||typeof f.removeChild!="function"||f.attributes!==L(f)||typeof f.removeAttribute!="function"||typeof f.setAttribute!="function"||typeof f.namespaceURI!="string"||typeof f.insertBefore!="function"||typeof f.hasChildNodes!="function"||f.nodeType!==z(f)||f.childNodes!==x(f)},Nn=function(f){if(!z||typeof f!="object"||f===null)return!1;try{return z(f)===qe.documentFragment}catch{return!1}},pr=function(f){if(!z||typeof f!="object"||f===null)return!1;try{return typeof z(f)=="number"}catch{return!1}};function ut(R,f,y){R.length!==0&&xn(R,T=>{T.call(e,f,y,Cn)})}let Df=function(f,y){return!!(Ft&&f.hasChildNodes()&&!pr(f.firstElementChild)&&Ne(Tp,f.textContent)&&Ne(Tp,f.innerHTML)||Ft&&f.namespaceURI===dt&&Ax[y]&&(pr(f.firstElementChild)||typeof f.textContent=="string"&&Ne(kx[y],f.textContent))||f.nodeType===qe.processingInstruction||Ft&&f.nodeType===qe.comment&&Ne(_p,f.data))},yo=function(f,y){if(f instanceof RegExp)return Ne(f,y);if(f instanceof Function){for(var T=arguments.length,O=new Array(T>2?T-2:0),H=2;H<T;H++)O[H-2]=arguments[H];return!!f(y,...O)}return!1},Uf=function(f,y,T){if(!ur[y]&&od(y)&&yo(ct.tagNameCheck,y))return!1;if(la&&!Rn[y]){let O=S(f),H=x(f);if(H&&O){let j=H.length;for(let se=j-1;se>=0;--se){let fe=f===T?p(H[se],!0):H[se];O.insertBefore(fe,v(f))}}}return It(f),!0},ed=function(f,y,T,O){return f.length===0?y:y===T||y===O?We(y):y},td=function(f,y){return f===y||S(f)!==null?!1:(ca&&go(f),!0)},nd=function(f,y){if(ut(ue.beforeSanitizeElements,f,null),td(f,y))return!0;if(bo(f))return It(f),!0;let T=ve(I(f));if(he=ed(ue.uponSanitizeElement,he,ra,lo),ut(ue.uponSanitizeElement,f,{tagName:T,allowedTags:he}),td(f,y))return!0;if(Df(f,T))return It(f),!0;if(ur[T]||!(kt.tagCheck instanceof Function&&kt.tagCheck(T))&&!he[T]){let H=Uf(f,T,y);return H===!1&&ut(ue.afterSanitizeElements,f,null),H}if(E(f)===qe.element&&!Mf(f)||(T==="noscript"||T==="noembed"||T==="noframes")&&Ne(_x,f.innerHTML))return It(f),!0;if(Rt&&f.nodeType===qe.text){let H=vo(f.textContent);f.textContent!==H&&(qr(e.removed,{element:f.cloneNode()}),f.textContent=H)}return ut(ue.afterSanitizeElements,f,null),!1},rd=function(f,y,T){if(Mc[y]||Zc(y,f)||Uc&&(y==="id"||y==="name")&&(T in n||T in If))return!1;let O=pe[y]||kt.attributeCheck instanceof Function&&kt.attributeCheck(y,f);return ia&&Ne(xf,y)||Lc&&Ne(Ef,y)?!0:O?Bc[y]||Ne(Oc,Wr(T,Nc,""))||(y==="src"||y==="xlink:href"||y==="href")&&f!=="script"&&mp(T,"data:")===0&&Fc[f]||Pc&&!Ne(Tf,Wr(T,Nc,""))?!0:!T:od(f)&&yo(ct.tagNameCheck,f)&&yo(ct.attributeNameCheck,y,f)||y==="is"&&ct.allowCustomizedBuiltInElements&&yo(ct.tagNameCheck,T)},Hf=ee({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),od=function(f){return!Hf[Yr(f)]&&Ne(_f,f)},Gf=function(f,y,T,O){if(B&&typeof m=="object"&&typeof m.getAttributeType=="function"&&!T)switch(m.getAttributeType(f,y)){case"TrustedHTML":return Sn(O);case"TrustedScriptURL":return pf(O)}return O},zf=function(f,y,T,O){try{T?f.setAttributeNS(T,y,O):f.setAttribute(y,O),bo(f)?It(f):pp(e.removed)}catch{Bt(y,f)}},id=function(f){ut(ue.beforeSanitizeAttributes,f,null);let y=f.attributes;if(!y||bo(f))return;pe=ed(ue.uponSanitizeAttribute,pe,oa,co);let T={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:pe,forceKeepAttr:void 0},O=y.length,H=ve(f.nodeName);for(;O--;){let j=y[O],se=j.name,fe=j.namespaceURI,De=j.value,Ue=ve(se),va=De,Me=se==="value"?va:sx(va);if(T.attrName=Ue,T.attrValue=Me,T.keepAttr=!0,T.forceKeepAttr=void 0,ut(ue.uponSanitizeAttribute,f,T),Me=T.attrValue,Hc&&(Ue==="id"||Ue==="name")&&mp(Me,Gc)!==0&&(Bt(se,f,j),Me=Gc+Me),Ft&&Ne(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,Me)){Bt(se,f,j);continue}if(Ue==="attributename"&&fp(Me,"href")){Bt(se,f,j);continue}if(!T.forceKeepAttr){if(!T.keepAttr){Bt(se,f,j);continue}if(!Dc&&Ne(Sx,Me)){Bt(se,f,j);continue}if(Rt&&(Me=vo(Me)),!rd(H,Ue,Me)){Bt(se,f,j);continue}Me=Gf(H,Ue,fe,Me),Me!==va&&zf(f,se,fe,Me)}}ut(ue.afterSanitizeAttributes,f,null)},wo=function(f){let y=null,T=Jc(f);for(ut(ue.beforeSanitizeShadowDOM,f,null);y=T.nextNode();)if(ut(ue.uponSanitizeShadowNode,y,null),nd(y,f),id(y),Nn(y.content)&&wo(y.content),E(y)===qe.element){let O=_(y);Nn(O)&&(ga(O),wo(O))}ut(ue.afterSanitizeShadowDOM,f,null)},ga=function(f){let y=[{node:f,shadow:null}];for(;y.length>0;){let T=y.pop();if(T.shadow){wo(T.shadow);continue}let O=T.node,j=E(O)===qe.element,se=x(O);if(se)for(let fe=se.length-1;fe>=0;--fe)y.push({node:se[fe],shadow:null});if(j){let fe=b?b(O):null;if(typeof fe=="string"&&ve(fe)==="template"){let De=O.content;Nn(De)&&y.push({node:De,shadow:null})}}if(j){let fe=_(O);Nn(fe)&&y.push({node:null,shadow:fe},{node:fe,shadow:null})}}};return e.sanitize=function(R){let f=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},y=null,T=null,O=null,H=null;if(da=!R,da&&(R="<!-->"),typeof R!="string"&&!pr(R)&&(R=ux(R),typeof R!="string"))throw wn("dirty is not a string, aborting");if(!e.isSupported)return R;sa?(he=lo,pe=co):fa(f),(ue.uponSanitizeElement.length>0||ue.uponSanitizeAttribute.length>0)&&(he=We(he)),ue.uponSanitizeAttribute.length>0&&(pe=We(pe)),e.removed=[];let j=ca&&typeof R!="string"&&pr(R);if(j){Pf(R);let De=I(R);if(typeof De=="string"){let Ue=ve(De);if(!he[Ue]||ur[Ue])throw mo(R),wn("root node is forbidden and cannot be sanitized in-place")}if(bo(R))throw mo(R),wn("root node is clobbered and cannot be sanitized in-place");try{ga(R)}catch(Ue){throw mo(R),Ue}}else if(pr(R))y=Qc("<!---->"),T=y.ownerDocument.importNode(R,!0),T.nodeType===qe.element&&T.nodeName==="BODY"||T.nodeName==="HTML"?y=T:y.appendChild(T),ga(T);else{if(!An&&!Rt&&!$t&&R.indexOf("<")===-1)return B&&ho?Sn(R):R;if(y=Qc(R),!y)return An?null:ho?ce:""}y&&aa&&It(y.firstChild);let se=j?R:y;try{let De=Jc(se);for(;O=De.nextNode();)nd(O,se),id(O),Nn(O.content)&&wo(O.content)}catch(De){throw j&&(mo(R),xn(e.removed,Ue=>{Ue.element&&go(Ue.element)})),De}if(j)return xn(e.removed,De=>{De.element&&go(De.element)}),Rt&&ma(R),R;if(An){if(Rt&&ma(y),uo)for(H=mf.call(y.ownerDocument);y.firstChild;)H.appendChild(y.firstChild);else H=y;return(pe.shadowroot||pe.shadowrootmode)&&(H=vf.call(r,H,!0)),H}let fe=$t?y.outerHTML:y.innerHTML;return $t&&he["!doctype"]&&y.ownerDocument&&y.ownerDocument.doctype&&y.ownerDocument.doctype.name&&Ne(Ex,y.ownerDocument.doctype.name)&&(fe="<!DOCTYPE "+y.ownerDocument.doctype.name+`>
`+fe),Rt&&(fe=vo(fe)),B&&ho?Sn(fe):fe},e.setConfig=function(){let R=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};fa(R),sa=!0,lo=he,co=pe},e.clearConfig=function(){Cn=null,sa=!1,lo=null,co=null,B=Te,ce=""},e.isValidAttribute=function(R,f,y){Cn||fa({});let T=ve(R),O=ve(f);return rd(T,O,y)},e.addHook=function(R,f){typeof f=="function"&&Fe(ue,R)&&qr(ue[R],f)},e.removeHook=function(R,f){if(Fe(ue,R)){if(f!==void 0){let y=ox(ue[R],f);return y===-1?void 0:ix(ue[R],y,1)[0]}return pp(ue[R])}},e.removeHooks=function(R){Fe(ue,R)&&(ue[R]=[])},e.removeAllHooks=function(){ue=Sp()},e}var Cp=Ip();function fc(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var _n=fc();function Hp(t){_n=t}var En={exec:()=>null};function ar(t){let e=[];return n=>{let r=Math.max(0,Math.min(3,n-1)),o=e[r];return o||(o=t(r),e[r]=o),o}}function Z(t,e=""){let n=typeof t=="string"?t:t.source,r={replace:(o,i)=>{let s=typeof i=="string"?i:i.source;return s=s.replace(Oe.caret,"$1"),n=n.replace(o,s),r},getRegex:()=>new RegExp(n,e)};return r}var Cx=((t="")=>{try{return!!new RegExp("(?<=1)(?<!1)"+t)}catch{return!1}})(),Oe={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:t=>new RegExp(`^( {0,3}${t})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:ar(t=>new RegExp(`^ {0,${t}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`)),hrRegex:ar(t=>new RegExp(`^ {0,${t}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`)),fencesBeginRegex:ar(t=>new RegExp(`^ {0,${t}}(?:\`\`\`|~~~)`)),headingBeginRegex:ar(t=>new RegExp(`^ {0,${t}}#`)),htmlBeginRegex:ar(t=>new RegExp(`^ {0,${t}}<(?:[a-z].*>|!--)`,"i")),blockquoteBeginRegex:ar(t=>new RegExp(`^ {0,${t}}>`))},Nx=/^(?:[ \t]*(?:\n|$))+/,Ox=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Mx=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Qr=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Lx=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,mc=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,Gp=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,zp=Z(Gp).replace(/bull/g,mc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}(?:\s|$)/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Px=Z(Gp).replace(/bull/g,mc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}(?:\s|$)/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),gc=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table|[ \t]+\n)[^\n]+)*)/,Dx=/^[^\n]+/,vc=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Ux=Z(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",vc).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Hx=Z(/^(bull)([ \t][^\n]*?)?(?:\n|$)/).replace(/bull/g,mc).getRegex(),Bs="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",bc=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Gx=Z("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n*|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>[^\\n]*\\n*|$)|<![A-Z][\\s\\S]*?(?:>[^\\n]*\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>[^\\n]*\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",bc).replace("tag",Bs).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Fp=t=>Z(gc).replace("hr",Qr).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*(?:\\n|$))|~~~)[^\\n]*(?:\\n|$)").replace("list",t).replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Bs).getRegex(),zx=Fp(/ {0,3}(?:[*+-]|1[.)])[ \t]+[^ \t\n]/),Fx=Fp(/ {0,3}(?:[*+-]|\d{1,9}[.)])(?:[ \t]|\n|$)/),$x=Z(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Fx).getRegex(),yc={blockquote:$x,code:Ox,def:Ux,fences:Mx,heading:Lx,hr:Qr,html:Gx,lheading:zp,list:Hx,newline:Nx,paragraph:zx,table:En,text:Dx},Np=Z("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Qr).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*(?:\\n|$))|~~~)[^\\n]*(?:\\n|$)").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Bs).getRegex(),Bx={...yc,lheading:Px,table:Np,paragraph:Z(gc).replace("hr",Qr).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Np).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*(?:\\n|$))|~~~)[^\\n]*(?:\\n|$)").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]+[^ \\t\\n]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Bs).getRegex()},jx={...yc,html:Z(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",bc).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:En,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:Z(gc).replace("hr",Qr).replace("heading",` *#{1,6} *[^
]`).replace("lheading",zp).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Vx=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,qx=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,$p=/^( {2,}|\\)\n(?!\s*$)/,Wx=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,At=/[\p{P}\p{S}]/u,lr=/[\s\p{P}\p{S}]/u,Jr=/[^\s\p{P}\p{S}]/u,Xx=Z(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,lr).getRegex(),Yx=/[\p{Pi}\p{Ps}"']/u,Bp=/(?!~)[\p{P}\p{S}]/u,Kx=/(?!~)[\s\p{P}\p{S}]/u,Zx=/(?:[^\s\p{P}\p{S}]|~)/u,Qx=Z(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",Cx?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),jp=/^(?:\*+(?:((?!\*)punct)|([^\s*]))?)|^_+(?:((?!_)punct)|([^\s_]))?/,Jx=Z(jp,"u").replace(/punct/g,At).getRegex(),eE=Z(jp,"u").replace(/punct/g,Bp).getRegex(),tE=/^(?:\*+(?:((?!\*)(?!openQuote)punct)|([^\s*]))?)|^_+(?:((?!_)(?!openQuote)punct)|([^\s_]))?/,nE=Z(tE,"u").replace(/openQuote/g,Yx).replace(/punct/g,At).getRegex(),Vp="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",rE=Z(Vp,"gu").replace(/notPunctSpace/g,Jr).replace(/punctSpace/g,lr).replace(/punct/g,At).getRegex(),oE=Z(Vp,"gu").replace(/notPunctSpace/g,Zx).replace(/punctSpace/g,Kx).replace(/punct/g,Bp).getRegex(),iE="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)[\\s](\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|(?:(?!\\*)punct|notPunctSpace)(\\*+)(?!\\*)(?=notPunctSpace)",sE=Z(iE,"gu").replace(/notPunctSpace/g,Jr).replace(/punctSpace/g,lr).replace(/punct/g,At).getRegex(),aE=Z("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Jr).replace(/punctSpace/g,lr).replace(/punct/g,At).getRegex(),lE="^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)[\\s](_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)|(?:(?!_)punct|notPunctSpace)(_+)(?!_)(?=notPunctSpace)",cE=Z(lE,"gu").replace(/notPunctSpace/g,Jr).replace(/punctSpace/g,lr).replace(/punct/g,At).getRegex(),dE=Z(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,At).getRegex(),uE="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",hE=Z(uE,"gu").replace(/notPunctSpace/g,Jr).replace(/punctSpace/g,lr).replace(/punct/g,At).getRegex(),pE=Z(/\\(punct)/,"gu").replace(/punct/g,At).getRegex(),fE=Z(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),mE=Z(bc).replace("(?:-->|$)","-->").getRegex(),gE=Z("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",mE).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),zs=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+(?!`)[^`]*?`+(?!`)|``+(?=\])|[^\[\]\\`])*?/,vE=Z(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label",zs).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]+|(?=\))/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),qp=Z(/^!?\[(label)\]\[(ref)\]/).replace("label",zs).replace("ref",vc).getRegex(),Wp=Z(/^!?\[(ref)\](?:\[\])?/).replace("ref",vc).getRegex(),bE=Z("reflink|nolink(?!\\()","g").replace("reflink",qp).replace("nolink",Wp).getRegex(),Op=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,wc={_backpedal:En,anyPunctuation:pE,autolink:fE,blockSkip:Qx,br:$p,code:qx,del:En,delLDelim:En,delRDelim:En,emStrongLDelim:Jx,emStrongRDelimAst:rE,emStrongRDelimUnd:aE,escape:Vx,link:vE,nolink:Wp,punctuation:Xx,reflink:qp,reflinkSearch:bE,tag:gE,text:Wx,url:En},yE={...wc,emStrongLDelim:nE,emStrongRDelimAst:sE,emStrongRDelimUnd:cE,link:Z(/^!?\[(label)\]\((.*?)\)/).replace("label",zs).getRegex(),reflink:Z(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",zs).getRegex()},uc={...wc,emStrongRDelimAst:oE,emStrongLDelim:eE,delLDelim:dE,delRDelim:hE,url:Z(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",Op).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:Z(/^(`+|~+|[^`~])(?:(?=[`~])|(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",Op).getRegex()},wE={...uc,br:Z($p).replace("{2,}","*").getRegex(),text:Z(uc.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Gs={normal:yc,gfm:Bx,pedantic:jx},Kr={normal:wc,gfm:uc,breaks:wE,pedantic:yE},xE={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Mp=t=>xE[t];function yt(t,e){if(e){if(Oe.escapeTest.test(t))return t.replace(Oe.escapeReplace,Mp)}else if(Oe.escapeTestNoEncode.test(t))return t.replace(Oe.escapeReplaceNoEncode,Mp);return t}function Lp(t){try{t=encodeURI(t).replace(Oe.percentDecode,"%")}catch{return null}return t}function Pp(t,e){let n=t.replace(Oe.findPipe,(i,s,a)=>{let l=!1,c=s;for(;--c>=0&&a[c]==="\\";)l=!l;return l?"|":" |"}),r=n.split(Oe.splitPipe),o=0;if(r[0].trim()||r.shift(),r.length>0&&!r.at(-1)?.trim()&&r.pop(),e)if(r.length>e)r.splice(e);else for(;r.length<e;)r.push("");for(;o<r.length;o++)r[o]=r[o].trim().replace(Oe.slashPipe,"|");return r}function zt(t,e,n){let r=t.length;if(r===0)return"";let o=0;for(;o<r;){let i=t.charAt(r-o-1);if(i===e&&!n)o++;else if(i!==e&&n)o++;else break}return t.slice(0,r-o)}function Dp(t){let e=t.split(`
`),n=e.length-1;for(;n>=0&&Oe.blankLine.test(e[n]);)n--;return e.length-n<=2?t:e.slice(0,n+1).join(`
`)}function EE(t,e){if(t.indexOf(e[1])===-1)return-1;let n=0;for(let r=0;r<t.length;r++)if(t[r]==="\\")r++;else if(t[r]===e[0])n++;else if(t[r]===e[1]&&(n--,n<0))return r;return n>0?-2:-1}function TE(t,e=0){let n=e,r="";for(let o of t)if(o==="	"){let i=4-n%4;r+=" ".repeat(i),n+=i}else r+=o,n++;return r}function Up(t,e,n,r,o){let i=e.href,s=e.title||null,a=t[1].replace(o.other.outputLinkReplace,"$1"),l=t[0].charAt(0)==="!";r.state.inLink=!0;let c=r.state.linkEmitted,u=r.state.inRawBlock;r.state.linkEmitted=!1;let m=r.inlineTokens(a),w=r.state.linkEmitted;if(r.state.linkEmitted=c,r.state.inLink=!1,!l){if(w){r.state.inRawBlock=u;return}r.state.linkEmitted=!0}return{type:l?"image":"link",raw:n,href:i,title:s,text:a,tokens:m}}function _E(t,e,n){let r=t.match(n.other.indentCodeCompensation);if(r===null)return e;let o=r[1];return e.split(`
...
`,t=t.substring(w.length+1),l=!0),!l){let v=this.rules.other.nextBulletRegex(h),x=this.rules.other.hrRegex(h),S=this.rules.other.fencesBeginRegex(h),_=this.rules.other.headingBeginRegex(h),L=this.rules.other.htmlBeginRegex(h),z=this.rules.other.blockquoteBeginRegex(h);for(;t;){let b=t.split(`
`,1)[0],A;if(w=b,this.options.pedantic?(w=w.replace(this.rules.other.listReplaceNesting,"  "),A=w):A=w.replace(this.rules.other.tabCharGlobal,"    "),S.test(w)||_.test(w)||L.test(w)||z.test(w)||v.test(w)||x.test(w))break;if(A.search(this.rules.other.nonSpaceChar)>=h||!w.trim())u+=`
...
`}strong({tokens:t}){return`<strong>${this.parser.parseInline(t)}</strong>`}em({tokens:t}){return`<em>${this.parser.parseInline(t)}</em>`}codespan({text:t}){return`<code>${yt(t,!0)}</code>`}br(t){return"<br>"}del({tokens:t}){return`<del>${this.parser.parseInline(t)}</del>`}link({href:t,title:e,tokens:n}){let r=this.parser.parseInline(n),o=Lp(t);if(o===null)return r;t=o;let i='<a href="'+t+'"';return e&&(i+=' title="'+yt(e)+'"'),i+=">"+r+"</a>",i}image({href:t,title:e,text:n,tokens:r}){r&&(n=this.parser.parseInline(r,this.parser.textRenderer));let o=Lp(t);if(o===null)return yt(n);t=o;let i=`<img src="${t}" alt="${yt(n)}"`;return e&&(i+=` title="${yt(e)}"`),i+=">",i}text(t){return"tokens"in t&&t.tokens?this.parser.parseInline(t.tokens):"escaped"in t&&t.escaped?t.text:yt(t.text)}},xc=class{strong({text:t}){return t}em({text:t}){return t}codespan({text:t}){return t}del({text:t}){return t}html({text:t}){return t}text({text:t}){return t}link({text:t}){return""+t}image({text:t}){return""+t}br(){return""}checkbox({raw:t}){return t}},at=class pc{options;renderer;textRenderer;constructor(e){this.options=e||_n,this.options.renderer=this.options.renderer||new $s,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new xc}static parse(e,n){return new pc(n).parse(e)}static parseInline(e,n){return new pc(n).parseInline(e)}parse(e){this.renderer.parser=this;let n="";for(let r=0;r<e.length;r++){let o=e[r];if(this.options.extensions?.renderers?.[o.type]){let s=o,a=this.options.extensions.renderers[s.type].call({parser:this},s);if(a!==!1||!["space","hr","heading","code","table","blockquote","list","checkbox","html","def","paragraph","text"].includes(s.type)){n+=a||"";continue}}let i=o;switch(i.type){case"space":{n+=this.renderer.space(i);break}case"hr":{n+=this.renderer.hr(i);break}case"heading":{n+=this.renderer.heading(i);break}case"code":{n+=this.renderer.code(i);break}case"table":{n+=this.renderer.table(i);break}case"blockquote":{n+=this.renderer.blockquote(i);break}case"list":{n+=this.renderer.list(i);break}case"checkbox":{n+=this.renderer.checkbox(i);break}case"html":{n+=this.renderer.html(i);break}case"def":{n+=this.renderer.def(i);break}case"paragraph":{n+=this.renderer.paragraph(i);break}case"text":{n+=this.renderer.text(i);break}default:{let s='Token with "'+i.type+'" type was not found.';if(this.options.silent)return console.error(s),"";throw new Error(s)}}}return n}parseInline(e,n=this.renderer){this.renderer.parser=this;let r="";for(let o=0;o<e.length;o++){let i=e[o];if(this.options.extensions?.renderers?.[i.type]){let a=this.options.extensions.renderers[i.type].call({parser:this},i);if(a!==!1||!["escape","html","link","image","checkbox","strong","em","codespan","br","del","text"].includes(i.type)){r+=a||"";continue}}let s=i;switch(s.type){case"escape":{r+=n.text(s);break}case"html":{r+=n.html(s);break}case"link":{r+=n.link(s);break}case"image":{r+=n.image(s);break}case"checkbox":{r+=n.checkbox(s);break}case"strong":{r+=n.strong(s);break}case"em":{r+=n.em(s);break}case"codespan":{r+=n.codespan(s);break}case"br":{r+=n.br(s);break}case"del":{r+=n.del(s);break}case"text":{r+=n.text(s);break}default:{let a='Token with "'+s.type+'" type was not found.';if(this.options.silent)return console.error(a),"";throw new Error(a)}}}return r}},Zr=class{options;block;constructor(t){this.options=t||_n}static passThroughHooks=new Set(["preprocess","postprocess","processAllTokens","emStrongMask"]);static passThroughHooksRespectAsync=new Set(["preprocess","postprocess","processAllTokens"]);preprocess(t){return t}postprocess(t){return t}processAllTokens(t){return t}emStrongMask(t){return t}provideLexer(t=this.block){return t?st.lex:st.lexInline}provideParser(t=this.block){return t?at.parse:at.parseInline}},Ec=class{defaults=fc();options=this.setOptions;parse=this.parseMarkdown(!0);parseInline=this.parseMarkdown(!1);Parser=at;Renderer=$s;TextRenderer=xc;Lexer=st;Tokenizer=Fs;Hooks=Zr;constructor(...t){this.use(...t)}walkTokens(t,e){let n=[];for(let r of t)switch(n=n.concat(e.call(this,r)),r.type){case"table":{let o=r;for(let i of o.header)n=n.concat(this.walkTokens(i.tokens,e));for(let i of o.rows)for(let s of i)n=n.concat(this.walkTokens(s.tokens,e));break}case"list":{let o=r;n=n.concat(this.walkTokens(o.items,e));break}default:{let o=r;this.defaults.extensions?.childTokens?.[o.type]?this.defaults.extensions.childTokens[o.type].forEach(i=>{let s=o[i].flat(1/0);n=n.concat(this.walkTokens(s,e))}):o.tokens&&(n=n.concat(this.walkTokens(o.tokens,e)))}}return n}use(...t){let e=this.defaults.extensions||{renderers:{},childTokens:{}};return t.forEach(n=>{let r={...n};if(r.async=this.defaults.async||r.async||!1,n.extensions&&(n.extensions.forEach(o=>{if(!o.name)throw new Error("extension name required");if("renderer"in o){let i=e.renderers[o.name];i?e.renderers[o.name]=function(...s){let a=o.renderer.apply(this,s);return a===!1&&(a=i.apply(this,s)),a}:e.renderers[o.name]=o.renderer}if("tokenizer"in o){if(!o.level||o.level!=="block"&&o.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");let i=e[o.level];i?i.unshift(o.tokenizer):e[o.level]=[o.tokenizer],o.start&&(o.level==="block"?e.startBlock?e.startBlock.push(o.start):e.startBlock=[o.start]:o.level==="inline"&&(e.startInline?e.startInline.push(o.start):e.startInline=[o.start]))}"childTokens"in o&&o.childTokens&&(e.childTokens[o.name]=o.childTokens)}),r.extensions=e),n.renderer){let o=this.defaults.renderer||new $s(this.defaults);for(let i in n.renderer){if(!(i in o))throw new Error(`renderer '${i}' does not exist`);if(["options","parser"].includes(i))continue;let s=i,a=n.renderer[s],l=o[s];o[s]=(...c)=>{let u=a.apply(o,c);return u===!1&&(u=l.apply(o,c)),u||""}}r.renderer=o}if(n.tokenizer){let o=this.defaults.tokenizer||new Fs(this.defaults);for(let i in n.tokenizer){if(!(i in o))throw new Error(`tokenizer '${i}' does not exist`);if(["options","rules","lexer"].includes(i))continue;let s=i,a=n.tokenizer[s],l=o[s];o[s]=(...c)=>{let u=a.apply(o,c);return u===!1&&(u=l.apply(o,c)),u}}r.tokenizer=o}if(n.hooks){let o=this.defaults.hooks||new Zr;for(let i in n.hooks){if(!(i in o))throw new Error(`hook '${i}' does not exist`);if(["options","block"].includes(i))continue;let s=i,a=n.hooks[s],l=o[s];Zr.passThroughHooks.has(i)?o[s]=c=>{if(this.defaults.async&&Zr.passThroughHooksRespectAsync.has(i))return(async()=>{let m=await a.call(o,c);return l.call(o,m)})();let u=a.call(o,c);return l.call(o,u)}:o[s]=(...c)=>{if(this.defaults.async)return(async()=>{let m=await a.apply(o,c);return m===!1&&(m=await l.apply(o,c)),m})();let u=a.apply(o,c);return u===!1&&(u=l.apply(o,c)),u}}r.hooks=o}if(n.walkTokens){let o=this.defaults.walkTokens,i=n.walkTokens;r.walkTokens=function(s){let a=[];return a.push(i.call(this,s)),o&&(a=a.concat(o.call(this,s))),a}}this.defaults={...this.defaults,...r}}),this}setOptions(t){return this.defaults={...this.defaults,...t},this}lexer(t,e){return st.lex(t,e??this.defaults)}parser(t,e){return at.parse(t,e??this.defaults)}parseMarkdown(t){return(e,n)=>{let r={...n},o={...this.defaults,...r},i=this.onError(!!o.silent,!!o.async);if(this.defaults.async===!0&&r.async===!1)return i(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof e>"u"||e===null)return i(new Error("marked(): input parameter is undefined or null"));if(typeof e!="string")return i(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(e)+", string expected"));if(o.hooks&&(o.hooks.options=o,o.hooks.block=t),o.async)return(async()=>{let s=o.hooks?await o.hooks.preprocess(e):e,a=await(o.hooks?await o.hooks.provideLexer(t):t?st.lex:st.lexInline)(s,o),l=o.hooks?await o.hooks.processAllTokens(a):a;o.walkTokens&&await Promise.all(this.walkTokens(l,o.walkTokens));let c=await(o.hooks?await o.hooks.provideParser(t):t?at.parse:at.parseInline)(l,o);return o.hooks?await o.hooks.postprocess(c):c})().catch(i);try{o.hooks&&(e=o.hooks.preprocess(e));let s=(o.hooks?o.hooks.provideLexer(t):t?st.lex:st.lexInline)(e,o);o.hooks&&(s=o.hooks.processAllTokens(s)),o.walkTokens&&this.walkTokens(s,o.walkTokens);let a=(o.hooks?o.hooks.provideParser(t):t?at.parse:at.parseInline)(s,o);return o.hooks&&(a=o.hooks.postprocess(a)),a}catch(s){return i(s)}}}onError(t,e){return n=>{if(n.message+=`
Please report this to https://github.com/markedjs/marked.`,t){let r="<p>An error occurred:</p><pre>"+yt(n.message+"",!0)+"</pre>";return e?Promise.resolve(r):r}if(e)return Promise.reject(n);throw n}}},Tn=new Ec;function ie(t,e){return Tn.parse(t,e)}ie.options=ie.setOptions=function(t){return Tn.setOptions(t),ie.defaults=Tn.defaults,Hp(ie.defaults),ie};ie.getDefaults=fc;ie.defaults=_n;function SE(...t){return Tn.use(...t),ie.defaults=Tn.defaults,Hp(ie.defaults),ie}ie.use=SE;ie.walkTokens=function(t,e){return Tn.walkTokens(t,e)};ie.parseInline=Tn.parseInline;ie.Parser=at;ie.parser=at.parse;ie.Renderer=$s;ie.TextRenderer=xc;ie.Lexer=st;ie.lexer=st.lex;ie.Tokenizer=Fs;ie.Hooks=Zr;ie.parse=ie;var rN=ie.options,oN=ie.setOptions,iN=ie.walkTokens,sN=ie.parseInline;var aN=at.parse,lN=st.lex;var AE=new Ec({gfm:!0,breaks:!0}),Xp=["a","p","br","strong","em","b","i","u","s","del","code","pre","ul","ol","li","blockquote","h1","h2","h3","h4","h5","h6","hr","span","table","thead","tbody","tr","th","td"],Yp=["href","title","class","target","rel"],Kp={ALLOWED_TAGS:Xp,ALLOWED_ATTR:Yp,ALLOW_DATA_ATTR:!1,ALLOW_ARIA_ATTR:!1},kE={...Kp,ALLOWED_TAGS:[...Xp,"img"],ALLOWED_ATTR:[...Yp,"src","alt","width","height"]},RE=/^language-[A-Za-z0-9_+#.-]+$/,IE=new Set(["CODE","PRE"]);function CE(t){t.nodeName==="A"&&t.hasAttribute("href")?(t.setAttribute("target","_blank"),t.setAttribute("rel","noopener noreferrer")):(t.removeAttribute("target"),t.removeAttribute("rel"));let e=t.getAttribute("class");if(e===null)return;let n=IE.has(t.nodeName)?e.split(/\s+/).filter(r=>RE.test(r)):[];if(n.length===0){t.removeAttribute("class");return}t.setAttribute("class",n.join(" "))}var js=null;function NE(){return js===null&&(js=Cp(),js.addHook("afterSanitizeAttributes",CE)),js}function eo(t,e){let n=e?.allowImages===!0,r=AE.parse(t,{async:!1});return NE().sanitize(r,n?kE:Kp).trim()}var Vs=class{#e;#t=null;#n=0;#o="";#r=null;constructor(e){this.#e=e}get deltas(){return this.#n}countDelta(){this.#n+=1}queue(e){this.#o=e,this.#i(),this.#r===null&&(this.#r=requestAnimationFrame(()=>{this.#r=null,this.into(this.#o)}))}into(e){this.#r!==null&&(cancelAnimationFrame(this.#r),this.#r=null),this.#o=e;let n=this.#i();return n.innerHTML=eo(e,{allowImages:this.#e.allowImages()}),this.#e.follow(),n}end(){this.#r!==null&&this.into(this.#o),this.#t=null}#i(){return this.#t===null&&(this.#t=this.#e.openBubble(),this.#n=0),this.#t}};var OE=4,ME=120;function Zp(t){if(typeof t!="object"||t===null)return null;let e=t.prompts;if(!Array.isArray(e))return null;let n=e.filter(r=>typeof r=="string").map(r=>r.trim()).filter(r=>r!==""&&r.length<=120).slice(0,4);return n.length===0?null:n}function to(t,e,n){let r=Zp(t);if(r===null)return null;let o=document.createElement("div");o.className="suggestions",o.setAttribute("part","suggestions"),o.setAttribute("role","group"),o.setAttribute("aria-label",e.suggestions);for(let i of r){let s=document.createElement("button");s.type="button",s.className="suggestion-chip",s.setAttribute("part","suggestion-chip"),s.textContent=i,s.addEventListener("click",()=>n(i)),o.appendChild(s)}return o}function Qp(t,e,n){let r=t.getAttribute("data-starters");if(r===null)return null;let o;try{o=JSON.parse(r)}catch{return console.warn(`<ag-ui-chat>: data-starters is not valid JSON, so no starters are shown. It takes an array of strings, e.g. data-starters='["Summarise this page"]'.`),null}return to({prompts:o},e,n)}function qs(t,e){for(let n of Array.from(t.querySelectorAll("pre"))){let r=n.querySelector("code");r===null||n.querySelector(".code-copy")!==null||(n.classList.add("has-copy"),n.append(LE(r,e)))}}function LE(t,e){let n=t.textContent,r=document.createElement("button");return r.type="button",r.className="code-copy",r.setAttribute("part","code-copy"),r.textContent=e.copyCode,r.title=e.copyCode,r.setAttribute("aria-label",e.copyCode),r.addEventListener("click",()=>{PE(n).then(o=>{DE(r,o?e.copied:e.copyFailed,e)})}),r}async function PE(t){let e=navigator.clipboard;if(e===void 0)return!1;try{return await e.writeText(t),!0}catch{return!1}}function DE(t,e,n){t.textContent=e,t.dataset.state=e===n.copied?"copied":"failed",setTimeout(()=>{t.textContent=n.copyCode,delete t.dataset.state},1500)}function Tc(t){let e=t.replace(/[._-]+/g," ").trim();return e===""?t:e.charAt(0).toUpperCase()+e.slice(1)}var Ws=class{element;#e;#t;#n;#o;#r=!1;constructor(e=le){this.#o=e,this.element=document.createElement("div"),this.element.className="thoughts",this.element.setAttribute("part","thoughts"),this.element.setAttribute("data-streaming",""),this.#n=document.createElement("button"),this.#n.type="button",this.#n.className="thoughts-toggle",this.#n.setAttribute("part","thoughts-toggle"),this.#n.setAttribute("aria-expanded","true"),this.#e=document.createElement("span"),this.#e.className="thoughts-label",this.#e.setAttribute("part","thoughts-label"),this.#e.textContent=e.thinking,this.#n.append(this.#e),this.#t=document.createElement("pre"),this.#t.className="thoughts-body",this.#t.setAttribute("part","thoughts-body"),this.#n.addEventListener("click",()=>{this.#i(!this.#r)}),this.element.append(this.#n,this.#t)}stream(e){this.#t.textContent=e}collapse(){this.#r||(this.element.removeAttribute("data-streaming"),this.#e.textContent=this.#o.thoughts,this.#i(!0))}#i(e){this.#r=e,this.#t.hidden=e,this.#n.setAttribute("aria-expanded",String(!e))}};function Xs(t,e){try{return t()}catch(n){return console.warn(`ag-ui-chat: render failed for ${e}`,n),null}}function Jp(t,e){for(let n of Array.from(t.childNodes))n.nodeType===Node.TEXT_NODE?e.push({node:n,parent:t}):Jp(n,e)}function ef(t){let e=[];Jp(t,e);let n=0;for(let{node:r,parent:o}of e){let i=document.createDocumentFragment();for(let s of r.data.split(/(\s+)/)){if(s==="")continue;if(/\s/.test(s)){i.appendChild(document.createTextNode(s));continue}let a=document.createElement("span");a.className="word",a.style.setProperty("--ag-ui-word-index",String(n)),a.textContent=s,i.appendChild(a),n+=1}o.replaceChild(i,r)}}function tf({viewport:t,onMissedContent:e}){let n=!0,r=!1,o=()=>t.scrollHeight-t.scrollTop-t.clientHeight<=4,i=u=>{u!==r&&(r=u,e(r))},s=()=>{t.scrollTop=t.scrollHeight},a=()=>{n=o(),n&&i(!1)},l=()=>{if(n){s();return}i(!0)};t.addEventListener("scroll",a,{passive:!0});let c=new ResizeObserver(()=>{n&&s()});return c.observe(t),{follow:l,jump:()=>{n=!0,i(!1),s()},following:()=>n,dispose:()=>{t.removeEventListener("scroll",a),c.disconnect()}}}var Ys=class{#e;#t=new Map;#n=new Map;#o=new Set;#r;#i=null;#s=null;#a=null;constructor(e){this.#e=e}mountScroller(e){e.addEventListener("click",()=>{this.jump()}),this.#r=tf({viewport:this.#e.messages,onMissedContent:n=>{e.dataset.missed=String(n)}})}disposeScroller(){this.#r.dispose()}follow(){this.#r.follow()}jump(){this.#r.jump()}isEmpty(){return!this.#e.emptyWrap.hidden}card(e){return this.#t.get(e)}cards(){return this.#t.values()}forgetCard(e){this.#t.delete(e)}setCardElement(e,n){this.#n.set(e,n)}markServerSettled(e){this.#o.add(e)}isServerSettled(e){return this.#o.has(e)}collapseThoughts(){this.#a?.collapse()}closeGroup(){this.#s!==null&&this.#s.childElementCount===0&&(this.#s.remove(),this.updateEmptyState()),this.#s=null,this.#a=null}releaseTurn(){this.#s=null,this.#a=null,this.hidePending(),this.#t.clear()}forgetCards(){this.#o.clear(),this.#n.clear()}empty(){this.#e.messages.replaceChildren(this.#e.emptyWrap),this.updateEmptyState()}append(e,n){let r=document.createElement("div");return r.className=`message message--${e}`,r.setAttribute("part",`message message-${e}`),e===Le.ASSISTANT?(r.innerHTML=eo(n,{allowImages:this.#e.allowImages()}),qs(r,this.#e.strings()),this.ensureGroup().appendChild(r)):(this.#s=null,r.textContent=n,this.#e.messages.appendChild(r)),this.updateEmptyState(),e===Le.USER?this.jump():this.follow(),r}ensureGroup(){if(this.#s===null){let e=document.createElement("div");e.className="answer",e.setAttribute("part","answer"),this.#s=e,this.#e.messages.appendChild(e),this.updateEmptyState()}return this.#s}revealWords(e){this.#e.element.getAttribute("data-text-animation")==="word"&&ef(e)}updateEmptyState(){this.#e.emptyWrap.hidden=this.#e.messages.childElementCount>1,this.#e.element.toggleAttribute("data-empty",!this.#e.emptyWrap.hidden)}appendStoppedNote(){let e=document.createElement("div");e.className="stopped-note",e.setAttribute("part","stopped"),e.setAttribute("role","status"),e.textContent=this.#e.strings().stopped,this.ensureGroup().appendChild(e),this.updateEmptyState(),this.follow()}showPending(){if(this.#i!==null)return;let e=document.createElement("div");e.className="pending",e.setAttribute("part","pending"),e.setAttribute("role","status"),e.setAttribute("aria-label",this.#e.strings().thinking);for(let n=0;n<3;n+=1){let r=document.createElement("span");r.className="pending-dot",e.appendChild(r)}this.#i=e,this.ensureGroup().appendChild(e),this.updateEmptyState(),this.follow()}hidePending(){this.#i?.remove(),this.#i=null}showThoughts(){if(this.#a===null){this.#a=new Ws(this.#e.strings());let e=this.ensureGroup();e.insertBefore(this.#a.element,e.firstChild),this.updateEmptyState(),this.follow()}return this.#a}noticeIfSkillLoad(e){let n=ds(e);return n===null?!1:(this.appendNotice("\u2728",oe(this.#e.strings().usingSkill,{name:n}),"skill"),!0)}appendNotice(e,n,r,o){this.ensureGroup().appendChild(Is(e,n,r,o)),this.updateEmptyState(),this.follow()}renderToolOutput(e,n){let r=Xs(()=>e(n.args),`tool ${n.name}`);r!==null&&(this.#n.get(n.id)?.after(r),this.afterGrew())}afterGrew(){this.updateEmptyState(),this.follow()}cardFor(e){let n=this.#t.get(e.id);if(n!==void 0)return n;let r=this.#e.resolveTool(e.name)?.parameters[xe],o=typeof r=="string"?r:this.#e.toolSummaries()[e.name]??this.#e.serverSummary(e.name)??Tc(e.name),i=new jr(e.name,e.args,o,this.#e.strings(),{formatPayload:s=>this.#e.formatToolPayload(s)});return this.#t.set(e.id,i),this.ensureGroup().appendChild(i.element),this.updateEmptyState(),this.follow(),i}};var Ks=class{#e;#t=new Map;#n=new Set;#o=new Map;constructor(e){this.#e=e}register(e){this.#t.set(e.type,e),this.#n.delete(e.type)}has(e){return this.#t.has(e)}unhandledTypes(){return[...this.#n]}clearBlocks(){this.#o.clear()}draw(e,n,r){let o=this.#t.get(n);if(o===void 0){this.#n.add(n);return}let i=Xs(()=>o.render(r),`activity ${n}`);if(i===null){this.#r(e,n,o.removedNotice,r);return}let s=this.#o.get(e);s===void 0?this.#e.ensureGroup().appendChild(i):s.replaceWith(i),this.#o.set(e,i),this.#e.afterTranscriptGrew()}#r(e,n,r,o){let i=this.#o.has(e);this.#o.get(e)?.remove(),this.#o.delete(e),console.warn(`ag-ui-chat: activity ${e} (${n}) was not drawable and has been removed. A chart's points must each be a finite JSON number; a numeric column serialised as a string (a Decimal, typically) is rejected rather than coerced.`,o),i&&r!==void 0&&this.#e.appendNotice("\u{1F4C9}",r,"chart-undrawable")}};var Zs=class extends Error{constructor(e){super(e),this.name="ConnectionLostError"}},no=class{#e;#t;#n;#o;#r;#i;#s;#a=new Set;#c=new Map;#d;#u;#p;#l;#h=!1;constructor(e){this.#e=e.agent,this.#t=e.handlers,this.#n=e.getTools??(()=>[]),this.#o=e.getContext??(()=>[]),this.#r=e.executeTool??null,this.#i=e.resolveInterrupts??null,this.#s=e.onPersist??(()=>{}),this.#d=e.connectionLostMessage??"Connection lost",this.#u=e.unfinishedMessage??"Not finished: the run ended or moved on before this tool call returned a result.",this.#p=e.declinedMessage??"User declined the action.";let n=e.maxToolRounds??Mn;this.#l=n>=1?Math.floor(n):Mn,this.#g();let r=e.onStateChanged;r!==void 0&&this.#e.subscribe({onStateChanged:({state:o})=>{r(o)}})}get state(){return this.#e.state}setState(e){this.#e.setState({...e})}get running(){return this.#e.isRunning}get messages(){return this.#e.messages}async send(e,n=[]){let r={id:be(),role:"user",content:e};n.length>0&&(r.attachments=n),this.#e.addMessage(r),this.#y(),await this.#m()}truncateToLastUser(){let e=[...this.#e.messages],n=-1;for(let[o,i]of e.entries())i.role==="user"&&(n=o);if(n===-1)return null;let r=e.slice(0,n+1);return this.#e.setMessages(r),this.#y(),r}async resume(){await this.#m()}addToolResult(e,n){this.#e.addMessage({id:be(),role:"tool",content:n,toolCallId:e}),this.#y()}cancel(){this.#h=!0,this.#e.abortRun()}async#m(){this.#h=!1;try{await this.#x(),this.#h&&this.#b()}catch(e){this.#h||UE(e)?this.#b():this.#t.onError(e instanceof Error?e.message:String(e))}finally{this.#t.onSettled()}}#b(){this.#y(),this.#t.onCancelled()}#g(){let e=this.#e.messages;e.some(n=>"outcome"in n)&&this.#e.setMessages(e.map(n=>{if(n.role!=="tool")return n;let{outcome:r,...o}=n;return this.#c.set(n.toolCallId,r),o}))}#w(e){let n=this.#e.messages,r=ls(n,o=>(this.#c.set(o,Pe.INTERRUPTED),{id:be(),role:"tool",content:this.#u,toolCallId:o}),e);r!==n&&(this.#e.setMessages([...r]),this.#y())}#f(e,n){for(let r of e){let o=r.toolCallId;o!==void 0&&n[r.id]?.status==="cancelled"&&(this.#c.set(o,Pe.DENIED),this.#e.addMessage({id:be(),role:"tool",content:this.#p,toolCallId:o}))}this.#y()}#y(){let e=this.#e.messages;if(this.#c.size===0){this.#s(e);return}this.#s(e.map(n=>{if(n.role!=="tool")return n;let r=this.#c.get(n.toolCallId);return r===void 0?n:{...n,outcome:r}}))}async#x(){let e,n=new Set;for(let r=0;r<this.#l;r+=1){if(this.#h)return;let o=[],i={terminal:!1,errored:!1,interrupts:[]},s={tools:this.#n(),context:this.#o()};if(e!==void 0&&(s.resume=e),this.#w(n),await this.#e.runAgent(s,this.#_(o,i)),e=void 0,n=new Set,this.#y(),this.#h)return;if(!i.terminal)throw new Zs(this.#d);if(i.errored)return;if(i.interrupts.length>0){if(this.#i===null)return;let l=await this.#i(i.interrupts);if(this.#h){this.#f(i.interrupts,l);return}e=Oh(i.interrupts,l),n=new Set(i.interrupts.flatMap(({toolCallId:c})=>c??[]));continue}if(this.#r===null||o.length===0)return;let a=!1;for(let l of o){if(this.#h)return;let c=await this.#r(l);if(c!==null){if(c.halt===!0)return;c.outcome!==void 0&&this.#c.set(l.id,c.outcome),this.#e.addMessage({id:be(),role:"tool",content:c.content,toolCallId:l.id}),this.#y(),a=!0}}if(!a)return}}#_(e,n){let r=this.#t,o=this.#a,i=this.#c,s=()=>this.#h,a=new Set;return{onRunInitialized(){r.onRunStart()},onTextMessageStartEvent({event:l}){o.has(l.messageId)&&console.warn(`<ag-ui-chat>: the server reused message id "${l.messageId}", which was already closed. Its content will be appended to that earlier message rather than starting a new one, and the merged result is what gets persisted. Issue a fresh id per message.`)},onTextMessageContentEvent({textMessageBuffer:l}){r.onTextDelta(l)},onTextMessageEndEvent({event:l,textMessageBuffer:c}){o.add(l.messageId),r.onTextEnd(c)},onToolCallEndEvent({event:l,toolCallName:c,toolCallArgs:u}){let m={id:l.toolCallId,name:c,args:u};e.push(m),r.onToolCall(m)},onToolCallResultEvent({event:l}){let c=l.outcome;typeof c=="string"&&i.set(l.toolCallId,c),r.onToolResult(l.toolCallId,l.content,c)},onActivitySnapshotEvent({event:l,messages:c}){if(c.some(m=>m.id===l.messageId&&m.role==="activity")){r.onActivityChanged(l.messageId,l.activityType,l.content);return}r.onActivity(l.activityType,l.content,l.messageId)},onActivityDeltaEvent({event:l}){a.add(l.messageId)},onCustomEvent({event:l}){r.onCustomEvent(l.name,l.value)},onSubagentStartedEvent({event:l}){r.onSubAgentStarted(l.subagentRunId,l.name,l.parentToolCallId??null)},onSubagentFinishedEvent({event:l}){r.onSubAgentFinished(l.subagentRunId)},onSubagentErrorEvent({event:l}){r.onSubAgentError(l.subagentRunId,l.message)},onMessagesSnapshotEvent({event:l}){r.onMessagesSnapshot(l.messages)},onMessagesChanged({messages:l}){if(a.size!==0){for(let c of a){let u=l.find(m=>m.id===c);u!==void 0&&u.role==="activity"&&r.onActivityChanged(c,u.activityType,u.content)}a.clear()}},onReasoningStartEvent(){r.onReasoningStart()},onReasoningMessageContentEvent({reasoningMessageBuffer:l}){r.onReasoningDelta(l)},onReasoningMessageEndEvent({reasoningMessageBuffer:l}){r.onReasoningDelta(l)},onReasoningEndEvent(){r.onReasoningEnd()},onRunFinishedEvent(l){n.terminal=!0,l.outcome==="interrupt"&&(n.interrupts=l.interrupts)},onRunErrorEvent({event:l}){n.terminal=!0,n.errored=!0,!s()&&r.onError(l.message)},onRunFinalized(){n.terminal=!0,r.onRunEnd()}}}};function UE(t){return t instanceof Error?t.name==="AbortError"||t instanceof TypeError&&/abort/i.test(t.message):!1}var nf="ag-ui-chat",cr="thread",_c="threads",ro="messages:",Js="checkpoint:",oo="minted:",HE=60,GE=100,zE="New conversation",rf=!1;function lt(t,e){try{sessionStorage.setItem(t,e)}catch{if(rf)return;rf=!0,console.warn("<ag-ui-chat>: the browser refused a sessionStorage write \u2014 the quota is full, or storage is disabled for this context. The conversation continues, but it will not survive a page reload. Deleting a long conversation from the history drawer frees the quota.")}}function Qs(t){return t===""?nf:`${nf}@${t}`}var Xe=class t{#e;constructor(e=""){this.#e=Qs(e),e!==""&&t.adopt("",e)}static adopt(e,n){let r=`${Qs(e)}:`,o=`${Qs(n)}:`;for(let[i,s]of of(r)){let a=sessionStorage.getItem(i),l=o+s;a!==null&&sessionStorage.getItem(l)===null&&lt(l,a),sessionStorage.removeItem(i)}}static purge(e){for(let[n]of of(`${Qs(e)}:`))sessionStorage.removeItem(n)}threadId(){return sessionStorage.getItem(this.#r(cr))??this.newThread()}newThread(){let e=be();return lt(this.#r(cr),e),lt(this.#r(oo+e),"1"),e}isUnsent(e){return sessionStorage.getItem(this.#r(oo+e))!==null&&sessionStorage.getItem(this.#r(ro+e))===null}loadMessages(e){return Promise.resolve(this.#i(this.#r(ro+e)))}saveMessages(e,n){lt(this.#r(ro+e),JSON.stringify(n)),sessionStorage.removeItem(this.#r(oo+e)),this.#t(e,n)}loadCheckpoint(e){return this.#i(this.#r(Js+e))}saveCheckpoint(e,n){let r=this.#r(Js+e);if(n===null){sessionStorage.removeItem(r);return}lt(r,JSON.stringify(n))}clear(e){sessionStorage.removeItem(this.#r(ro+e)),sessionStorage.removeItem(this.#r(Js+e)),sessionStorage.removeItem(this.#r(oo+e)),this.#o(this.#n().filter(n=>n.threadId!==e)),sessionStorage.getItem(this.#r(cr))===e&&sessionStorage.removeItem(this.#r(cr))}listThreads(){let e=this.#n().sort((n,r)=>r.updatedAt-n.updatedAt).map(({threadId:n,title:r,updatedAt:o,preview:i})=>({threadId:n,title:r,updatedAt:o,preview:i}));return Promise.resolve(e)}setActiveThread(e){lt(this.#r(cr),e)}renameThread(e,n){let r=this.#n(),o=r.find(i=>i.threadId===e);o!==void 0&&(o.title=n,o.titleCustom=!0,this.#o(r))}#t(e,n){let r=this.#n(),o=r.find(a=>a.threadId===e),i=$E(n),s=Date.now();o===void 0?r.push({threadId:e,title:sf(n),titleCustom:!1,preview:i,updatedAt:s}):(o.preview=i,o.updatedAt=s,o.titleCustom||(o.title=sf(n))),this.#o(r)}#n(){return this.#i(this.#r(_c))??[]}#o(e){let n=this.#r(_c);if(e.length===0){sessionStorage.removeItem(n);return}lt(n,JSON.stringify(e))}#r(e){return`${this.#e}:${e}`}#i(e){let n=sessionStorage.getItem(e);if(n===null)return null;try{return JSON.parse(n)}catch{return null}}};function of(t){let e=[];for(let n=0;n<sessionStorage.length;n+=1){let r=sessionStorage.key(n);if(r===null||!r.startsWith(t))continue;let o=r.slice(t.length);FE(o)&&e.push([r,o])}return e}function FE(t){return t===cr||t===_c||t.startsWith(ro)||t.startsWith(Js)||t.startsWith(oo)}function sf(t){for(let e of t)if(e.role==="user"){let n=af(e.content);if(n!=="")return lf(n,HE)}return zE}function $E(t){for(let e of[...t].reverse()){let n=af(e.content);if(n!=="")return lf(n,GE)}return""}function af(t){return typeof t=="string"?t.replace(/\s+/g," ").trim():""}function lf(t,e){return t.length<=e?t:`${t.slice(0,e-1).trimEnd()}\u2026`}function Sc(t){let e=t.headers??{},n=new Set;return new Mh({url:t.endpoint,headers:e,initialState:{...t.initialState??{}},fetch:(r,o)=>{let i=t.getHeaders?.(),s=[...new Set([...Object.keys(e),...Object.keys(i??{})])].sort();if(as(r,s,t.trustedOrigins??[],n),i===void 0)return fetch(r,et(o,t.credentials));let a=new Headers(o?.headers);for(let[l,c]of Object.entries(i))a.set(l,c);return fetch(r,et({...o,headers:a},t.credentials))},...t.threadId!==void 0?{threadId:t.threadId}:{},...t.initialMessages!==void 0?{initialMessages:[...t.initialMessages]}:{}})}function cf(t){let e=t.getAttribute("data-max-tool-rounds");return e===null?Mn:Number.parseInt(e,10)}var io=class{#e;#t;#n;#o;#r;#i=new Set;#s=new Map;constructor(e,n=()=>({}),r=new Xe,o=()=>{},i=!0){this.#e=e.endsWith("/")?e:`${e}/`,this.#t=n,this.#n=r,this.#o=o,this.#r=i}threadId(){return this.#n.threadId()}setActiveThread(e){this.#n.setActiveThread(e)}newThread(){return ss(this.#n)}isUnsent(e){return this.#n.isUnsent?.(e)===!0}saveMessages(e,n){this.#n.saveMessages(e,this.#r?n:[])}loadCheckpoint(e){return this.#n.loadCheckpoint(e)}saveCheckpoint(e,n){this.#n.saveCheckpoint(e,n)}renameThread(e,n){this.#n.renameThread(e,n),this.#s.set(e,n),this.#p(e,"PATCH",{title:n})}clear(e){this.#n.clear(e),this.#i.add(e),this.#p(e,"DELETE")}async listThreads(){let e=await this.#a();return e===null?this.#n.listThreads():e.filter(n=>!this.#i.has(n.thread_id)).map(n=>this.#d(n))}async loadMessages(e){if(this.#n.isUnsent?.(e)===!0)return null;let n=await this.#u(`${this.#e}${encodeURIComponent(e)}/`);if(n===null||!n.ok)return this.#n.loadMessages(e);let r=await this.#c(n);return r===null?this.#n.loadMessages(e):r.messages??null}async#a(){let e=await this.#u(this.#e);if(e===null||!e.ok)return null;let n=await this.#c(e);return n===null?null:n.threads??[]}async#c(e){try{return await e.json()}catch{return null}}#d(e){return{threadId:e.thread_id,title:this.#s.get(e.thread_id)??e.title,updatedAt:e.updated_at===null?Number.NaN:Date.parse(e.updated_at),preview:e.preview}}async#u(e){try{return await fetch(e,et({headers:this.#t()},this.#o()))}catch{return null}}async#p(e,n,r){let o=this.#t();try{await fetch(`${this.#e}${encodeURIComponent(e)}/`,et({method:n,headers:r===void 0?o:{...o,"content-type":"application/json"},body:r===void 0?null:JSON.stringify(r)},this.#o()))}catch{}}};function df(){return{tools:[],serverSettled:new Set,invalidated:new Set,announcedOutcome:!1}}function BE(t,e){let n={};for(let[r,o]of Object.entries(t))n[r]=(...i)=>{e()&&o(...i)};return n}var ea=class{#e;#t=df();constructor(e){this.#e=e}detach(){this.#t=df()}forClient(){let e=this.#t,n=()=>e===this.#t,{onSettled:r,...o}=this.#n(e);return{...BE(o,n),onSettled:()=>{n()&&r(),this.#o(e)}}}#n(e){return{onRunStart:()=>{this.#e.running()||(e.announcedOutcome=!1,this.#e.announcer.announce(this.#e.strings().announceResponding)),this.#e.setRunning(!0),this.#e.transcript.ensureGroup(),this.#e.transcript.showPending()},onReasoningStart:()=>{this.#e.transcript.hidePending(),this.#e.transcript.showThoughts()},onReasoningDelta:n=>{this.#e.transcript.showThoughts().stream(n)},onReasoningEnd:()=>{},onTextDelta:n=>{this.#e.transcript.hidePending(),this.#e.transcript.collapseThoughts(),this.#e.stream.queue(n),this.#e.stream.countDelta()},onTextEnd:n=>{if(n===""){this.#e.stream.end();return}let r=this.#e.stream.into(n);this.#e.stream.deltas<=1&&this.#e.transcript.revealWords(r),qs(r,this.#e.strings()),this.#e.actions.attach(r),this.#e.stream.end(),this.#e.noteUnread()},onToolCall:n=>{this.#e.transcript.hidePending(),!this.#e.transcript.noticeIfSkillLoad(n)&&(e.tools.push({id:n.id,name:n.name}),this.#e.transcript.cardFor(n))},onActivity:(n,r,o)=>{this.#e.activities.draw(o,n,r)},onCustomEvent:(n,r)=>{if(n===Ia){this.#r(e,r);return}if(n===sd){this.#e.subagents.report(r);return}this.#e.element.dispatchEvent(new CustomEvent(Sa,{detail:{name:n,value:r},bubbles:!0,composed:!0}))},onSubAgentStarted:(n,r,o)=>{this.#e.subagents.start(n,r,o)},onSubAgentFinished:n=>{this.#e.subagents.finish(n)},onSubAgentError:(n,r)=>{this.#e.subagents.fail(n,r)},onMessagesSnapshot:()=>{this.#e.transcript.appendNotice("\u{1F504}",this.#e.strings().historyReplaced,"history-replaced")},onToolResult:(n,r,o)=>{let i=this.#e.transcript.card(n);i!==void 0&&(i.settle(Gr(o),r),this.#e.transcript.markServerSettled(n),e.serverSettled.add(n),this.#e.transcript.showPending())},onActivityChanged:(n,r,o)=>{this.#e.activities.draw(n,r,o)},onRunEnd:()=>{this.#e.transcript.hidePending(),this.#e.stream.end()},onError:n=>{e.announcedOutcome=!0,this.#e.announcer.announce(this.#e.strings().announceFailed),this.#e.transcript.hidePending();let r=this.#e.appendMessage(Le.ASSISTANT,`\u26A0\uFE0F ${n}`);r.classList.add("message--failed"),this.#e.actions.attach(r,{rateable:!1}),this.#e.transcript.revealWords(r),this.#e.stream.end()},onCancelled:()=>{e.announcedOutcome=!0,this.#e.announcer.announce(this.#e.strings().announceStopped),this.#e.transcript.hidePending(),this.#e.transcript.appendStoppedNote(),this.#e.stream.end()},onSettled:()=>{e.announcedOutcome||this.#e.announcer.announce(this.#e.strings().announceAnswerReady),this.#e.transcript.hidePending(),this.#e.setRunning(!1),this.#e.stream.end();for(let n of this.#e.transcript.cards())n.settled||n.settle(te.INTERRUPTED,this.#e.strings().callNotFinished);this.#e.transcript.closeGroup()}}}#o(e){let n=e.tools.map(({id:o,name:i})=>({name:i,side:e.serverSettled.has(o)?"server":"client"})),r=[...e.invalidated];e.tools.length=0,e.serverSettled.clear(),e.invalidated.clear(),this.#e.element.dispatchEvent(new CustomEvent(_a,{detail:{tools:n,invalidated:r},bubbles:!0,composed:!0}))}#r(e,n){let r=n??{},o=Array.isArray(r.keys)?r.keys.filter(i=>typeof i=="string"):[];if(o.length!==0){for(let i of o)e.invalidated.add(i);this.#e.element.dispatchEvent(new CustomEvent(Aa,{detail:{keys:o,reason:typeof r.reason=="string"?r.reason:null},bubbles:!0,composed:!0}))}}};var Ac=new Set,ta=class{#e;#t="";#n=null;#o="";#r="";#i=null;constructor(e){this.#e=e}claim(){this.#t=this.#s()}release(){this.#n!==null&&(Ac.delete(this.#n),this.#n=null)}conversationNamespace(e){return e===""?this.#t:`${this.#t}#${e}`}scopeStore(e,n){if(!(e instanceof Xe))return e;let r=this.conversationNamespace(n);return this.#i=r===""?e:new Xe(r),this.#i}rescopeStore(e){return this.#i===null?null:(this.#i=new Xe(e),this.#i)}key(e){return this.#t===""?e:`${e}:${this.#t}`}readScopedItem(e){let n=sessionStorage.getItem(this.key(e));return n!==null||this.#t===""?n:sessionStorage.getItem(e)}readPreference(e){try{let n=localStorage.getItem(this.key(e));if(n!==null)return n}catch{}return this.readScopedItem(e)}writePreference(e,n){let r=this.key(e);try{localStorage.setItem(r,n)}catch{}lt(r,n)}clearPreference(e){let n=this.key(e);try{localStorage.removeItem(n)}catch{}try{sessionStorage.removeItem(n)}catch{}}#s(){let e=this.#e.id(),n=e!==""?e:this.#e.endpoint();return n===""?"":this.#r===n?this.#o:Ac.has(n)?(this.#r=n,this.#o=`${n}~${be()}`,console.warn(`<ag-ui-chat>: another element on this page already stores its conversation under "${n}", so this one has been given a throwaway namespace of its own \u2014 the two would otherwise share a thread pointer, a history drawer and every message. Give each <ag-ui-chat> its own id to keep them apart and let this one restore its conversation across reloads.`),this.#o):(Ac.add(n),this.#n=n,n)}};var jE=["data-attachments-url","data-attachment-accept","data-attachment-max-bytes","data-transcribe-url","data-threads-url","data-threads-cache","data-tools-url","data-skills-url","data-skills","data-prompt-chips","data-slash-commands","data-theme-toggle","data-strings","data-icon-url"],Rc=["omit","same-origin","include"];function kc(t){return Rc.includes(t)}var uf="ag-ui-chat:collapsed",hf="ag-ui-chat:theme",so=class extends HTMLElement{agentFactory=Sc;headers={};getHeaders=null;trustedOrigins=[];allowImages=!1;formatRelativeTime=null;autoConfirm=!1;askUser=!1;askUserRenderer=null;approvalRenderer=null;approveWithEdits=!1;confirmPredicate=null;getTools=()=>this.#R.defaultTools();getContext=()=>[...Va(this.getPageMap,this.autoInjectPageMap)];routeMap=[];navigate=null;getPageMap=null;autoInjectPageMap=!0;conversationStore=new Xe;uploadHandler=null;transcribeHandler=null;navigationResult=()=>({navigated:!0,url:window.location.href});skillContext=()=>({});toolSummaries={};formatToolPayload=null;strings={};resolvePageTarget=e=>document.querySelector(e);#e=new Set;#t=le;#n=new Ns({card:e=>this.#v.card(e),strings:()=>this.#t,follow:()=>this.#v.follow()});#o=new Ks({ensureGroup:()=>this.#v.ensureGroup(),afterTranscriptGrew:()=>this.#v.afterGrew(),appendNotice:(e,n,r)=>this.#v.appendNotice(e,n,r)});#r=new Us({element:this,strings:()=>this.#t,retry:()=>{this.retryLastTurn()}});#i;#s=new Rs;#a=document.createElement("button");#c;#d=document.createElement("div");#u;#p;#l;#h;#m;#b;#g;#w;#f;#y;#x;#_;#M;#A;#E;#k;#N=document.createElement("span");#F=0;#I;#v;#L;#J;#se=document.createElement("span");#C;#T;#$=[];#D=[];#O=document.createElement("div");#U=null;#B=()=>{this.#T.publishVisualViewport(),!this.#T.dragging()&&this.#T.restoreLauncherPosition()};#X;#ee;#j=!1;#H=null;#G={};#P=!1;#te=new _s;#R=new cs({element:this,routeMap:()=>this.routeMap,navigate:()=>this.navigate,getPageMap:()=>this.getPageMap,resolvePageTarget:e=>this.resolvePageTarget(e),getTools:()=>this.getTools(),askUser:()=>this.askUser,askUserRenderer:()=>this.askUserRenderer,decision:this.#te,ensureGroup:()=>this.#v.ensureGroup(),strings:()=>this.#t,hidePending:()=>this.#v.hidePending(),updateEmptyState:()=>this.#v.updateEmptyState(),follow:()=>this.#v.follow(),fetchInit:e=>this.#ce(e)});#ae=new Vs({openBubble:()=>this.appendMessage(Le.ASSISTANT,""),allowImages:()=>this.allowImages,follow:()=>this.#v.follow()});#S=new ta({id:()=>this.id,endpoint:()=>this.endpoint});#V;constructor(){super(),this.#i=this.attachShadow({mode:"open"}),this.#u=document.createElement("div"),this.#p=document.createElement("div"),this.#l=document.createElement("textarea"),this.#h=document.createElement("button"),this.#m=document.createElement("span"),this.#y=document.createElement("div"),this.#x=document.createElement("button"),this.#_=document.createElement("input"),this.#M=document.createElement("div"),this.#X=document.createElement("span"),this.#A=document.createElement("button"),this.#E=document.createElement("button"),this.#k=document.createElement("span"),this.#I=document.createElement("div"),this.#v=new Ys({element:this,messages:this.#p,emptyWrap:this.#I,strings:()=>this.#t,allowImages:()=>this.allowImages,resolveTool:e=>this.#R.resolve(e),toolSummaries:()=>this.toolSummaries,serverSummary:e=>this.#R.summary(e),formatToolPayload:e=>this.formatToolPayload?.(e)??null}),this.#L=new hs({element:this,transcript:this.#v,tools:this.#R,decision:this.#te,strings:()=>this.#t,announce:e=>this.#s.announce(e),autoConfirm:()=>this.autoConfirm,confirmPredicate:()=>this.confirmPredicate,getPageMap:()=>this.getPageMap,navigate:()=>this.navigate,approveWithEdits:()=>this.approveWithEdits,approvalRenderer:()=>this.approvalRenderer,getContext:()=>this.getContext(),conversationStore:()=>this.conversationStore,threadId:()=>this.#f.threadId}),this.#J=new ea({element:this,transcript:this.#v,stream:this.#ae,actions:this.#r,activities:this.#o,subagents:this.#n,announcer:this.#s,strings:()=>this.#t,running:()=>this.#P,setRunning:e=>this.#W(e),appendMessage:(e,n)=>this.appendMessage(e,n),noteUnread:()=>this.#Se()}),this.#T=new ks({element:this,launcher:this.#E,root:this.#i,connected:()=>this.#j,collapsed:()=>this.collapsed,collapsible:()=>zr(this.getAttribute("placement")),strings:()=>this.#t,readPreference:e=>this.#S.readPreference(e),writePreference:(e,n)=>this.#S.writePreference(e,n),clearPreference:e=>this.#S.clearPreference(e),announceSurfaceChange:(e,n)=>this.#be(e,n)}),this.#c=new xs({element:this,root:this.#i,messages:this.#p,messagesWrap:this.#d,input:this.#l,strings:()=>this.#t,autoGrow:()=>Ut(this.#l),quote:e=>this.quote(e)}),this.#C=new vs({element:this,chat:this.#u,slot:this.#M,fileInput:this.#_,button:this.#x,strings:()=>this.#t,uploadHandler:()=>this.uploadHandler,headersFor:e=>this.#q(e),credentialsOption:()=>this.#re()}),this.#ee=new ys({element:this,slot:this.#X,input:this.#l,strings:()=>this.#t,transcribeHandler:()=>this.transcribeHandler,headersFor:e=>this.#q(e),credentialsOption:()=>this.#re(),onInput:()=>this.#ge()}),this.registerActivityRenderer({type:Na,render:e=>{let n=VE(e);return n===null?null:Is("\u{1F5DC}",oe(this.#t.historyCompacted,{count:n}),"compaction")}}),this.registerActivityRenderer({type:Ra,render:e=>to(e,this.#t,n=>{this.sendMessage(n)})}),this.#b=new ws(e=>this.#V.apply(e)),this.#V=new Ao({element:this,menu:this.#b,input:this.#l,hint:this.#y,strings:()=>this.#t,context:()=>this.skillContext(),flag:e=>this.#we(e),readJsonAttribute:e=>this.#de(e),fetchInit:e=>this.#ce(e),send:e=>{this.sendMessage(e)},submit:()=>{this.#oe()},autoGrow:()=>Ut(this.#l)}),this.#g=new Ts({onSelect:e=>{this.#f.switchThread(e)},onNew:()=>{this.newChat(),this.#f.refreshDrawer()},onRename:(e,n)=>{this.#f.renameThread(e,n)},onDelete:e=>{this.#f.deleteThread(e)}}),this.#w=new Ur((e,n)=>{this.#f.continueRun(e,n)}),this.#f=new Es({element:this,drawer:this.#g,checkpoints:this.#w,transcript:this.#v,actions:this.#r,activities:this.#o,tools:this.#R,input:this.#l,hint:this.#y,strings:()=>this.#t,conversationStore:()=>this.conversationStore,formatRelativeTime:()=>this.formatRelativeTime,navigationResult:()=>this.navigationResult,headersFor:e=>this.#q(e),requestCredentials:()=>this.#Y(),appendMessage:(e,n)=>this.appendMessage(e,n),autoGrow:()=>Ut(this.#l),ensureClient:()=>this.#ie(),buildClient:e=>this.#ve(e),cancelRun:()=>this.#z(),resetState:()=>this.#K(),setRunning:e=>this.#W(e)})}static get observedAttributes(){return["title-text","placement","credentials","user-key","user-name",...jE]}attributeChangedCallback(e,n,r){if(e==="credentials"){r!==null&&!kc(r)&&console.error(`<ag-ui-chat>: credentials="${r}" is not a fetch credentials mode (${Rc.join(" / ")}) \u2014 it is being ignored, so requests use the browser default and cross-origin cookies will not be sent.`);return}if(e==="placement"){this.#T.releaseOwnedAxes(),this.#T.releaseLauncherPosition(),!zr(this.getAttribute("placement"))&&this.collapsed&&this.setCollapsed(!1),requestAnimationFrame(()=>this.#T.syncResizeAnchor());return}if(e==="title-text"){this.#m.textContent=r??this.#t.title,this.#N.textContent=this.#m.textContent;return}if(e==="user-name"){this.#le();return}if(e==="user-key"){this.#j&&(n??"")!==(r??"")&&this.#Te(n??"",r??"");return}n===r||!this.#j||console.warn(`<ag-ui-chat>: "${e}" was changed after the element connected, and is read only while connecting \u2014 this assignment has no effect. Set it before the element enters the DOM (in the markup, or on the element before appending it); frameworks that patch attributes after mount should bind it at creation. To apply a new value now, remove and re-insert the element.`)}registerTool(e){this.#R.register(e)}get sharedState(){return this.#H?.state??this.#G}set sharedState(e){this.#G={...e},this.#H?.setState(this.#G)}registerPageState(e){this.#R.registerPageState(e)}registerStateHook(e){this.registerPageState(e)}get endpoint(){return this.getAttribute("endpoint")??""}set endpoint(e){this.setAttribute("endpoint",e)}get userKey(){return this.getAttribute("user-key")??""}set userKey(e){this.setAttribute("user-key",e)}get userName(){return this.getAttribute("user-name")??""}set userName(e){this.setAttribute("user-name",e)}#le(){let e=this.userName.trim();this.#se.textContent=e===""?this.#t.greetingNoName:oe(this.#t.greeting,{name:e})}get credentials(){let e=this.getAttribute("credentials");return e!==null&&kc(e)?e:null}set credentials(e){if(e===null){this.removeAttribute("credentials");return}if(!kc(e))throw new TypeError(`<ag-ui-chat>: credentials must be one of ${Rc.map(n=>`"${n}"`).join(", ")} (got ${JSON.stringify(e)}).`);this.setAttribute("credentials",e)}#ne(){return{...this.headers,...this.getHeaders?.()}}#q(e){let n=this.#ne();return as(e,Object.keys(n),this.trustedOrigins,this.#e),n}#Y(){return this.credentials??void 0}#re(){let e=this.#Y();return e===void 0?{}:{credentials:e}}#ce(e){return et({headers:this.#q(e)},this.#Y())}get toolDisplay(){let e=this.getAttribute("data-tool-display");return e===Ln.INLINE||e===Ln.MINIMAL||e===Ln.COMPACT?e:Ln.FULL}set toolDisplay(e){this.setAttribute("data-tool-display",e)}connectedCallback(){if(this.#S.claim(),this.#T.restoreSize(),requestAnimationFrame(()=>{this.#T.restoreLauncherPosition(),this.#T.syncResizeAnchor()}),this.#t=Pl({...this.#xe(),...this.strings}),this.getAttribute("data-theme-toggle")!==null){let e=this.#S.readPreference(hf);e!==null&&this.setAttribute("theme",e)}this.#_e(),this.#g.setStrings(this.#t),this.#w.setStrings(this.#t),zr(this.getAttribute("placement"))&&this.#Ee()&&this.setAttribute("collapsed",""),this.#me(),this.#V.init(),this.conversationStore=this.#S.scopeStore(this.conversationStore,this.userKey),window.addEventListener("resize",this.#B),window.visualViewport?.addEventListener("resize",this.#B),window.visualViewport?.addEventListener("scroll",this.#B),this.#T.publishVisualViewport(),this.#ue(),this.#C.wire(),this.#ee.wire(),this.#f.adoptActiveThread(),queueMicrotask(()=>this.#ye()),this.#f.rehydrate(),this.#j=!0}#ye(){this.#j&&(this.#R.fetchCatalog(),this.#V.fetch())}async reload(){this.#z(),this.#K(),this.#W(!1),await Promise.all([this.#R.fetchCatalog(),this.#V.fetch(),this.#f.rehydrate()])}disconnectedCallback(){this.#j=!1,window.removeEventListener("resize",this.#B),window.visualViewport?.removeEventListener("resize",this.#B),window.visualViewport?.removeEventListener("scroll",this.#B),this.#S.release(),this.#z(),this.#c.detachPageOffer(),this.#C.tray?.dispose(),this.#ee.dispose(),this.#v.disposeScroller(),this.#s.dispose()}#we(e){let n=this.getAttribute(e);return n!==null&&n!=="false"}#de(e){let n=this.getAttribute(e);if(n===null)return null;try{return JSON.parse(n)}catch{return console.warn(`<ag-ui-chat>: ${e} is not valid JSON, so it was ignored entirely and the built-in default is being used. Check the quoting -- JSON inside an HTML attribute needs single quotes around the attribute value, or its own double quotes escaped.`),null}}#xe(){let e=this.#de("data-strings");return typeof e=="object"&&e!==null?e:{}}quote(e){this.#c.insert(e)}offerQuoteInPage(e=document.body){return this.#c.offerInPage(e)}#ue(){let e=this.getAttribute("data-threads-url");e!==null&&(this.conversationStore=new io(e,()=>this.#q(e),this.conversationStore,()=>this.#Y(),this.getAttribute("data-threads-cache")!=="false"))}setSkills(e){this.#V.setClientSkills(e)}get collapsed(){return this.hasAttribute("collapsed")}set collapsed(e){this.setCollapsed(e)}setCollapsed(e,n={}){e&&!zr(this.getAttribute("placement"))||(n.announce===!0&&e&&!this.collapsed&&this.#be(this.#t.chatMinimised,null),e||this.#T.restoreLauncherPosition(),e?this.setAttribute("collapsed",""):this.removeAttribute("collapsed"),lt(this.#S.key(uf),e?"1":"0"),this.#Z(0),this.dispatchEvent(new CustomEvent(wa,{detail:{collapsed:e},bubbles:!0,composed:!0})))}get unread(){return this.#F}#Ee(){let e=this.#S.readScopedItem(uf);return e!==null?e==="1":Ss(this.getAttribute("placement"))&&!this.hasAttribute("data-start-open")}describeSurface(){return this.#T.describeSurface()}moveTo(e,n={}){return this.#T.moveTo(e,n)}toggleCollapsed(){this.setCollapsed(!this.collapsed)}toggleTheme(){let e=this.getAttribute("theme")==="dark"?"light":"dark";this.setAttribute("theme",e),this.#S.writePreference(hf,e),this.#pe()}#Te(e,n){let r=this.#S.conversationNamespace(e),o=this.#S.conversationNamespace(n);if(e===""){Xe.adopt(r,o),this.#he(o);return}Xe.purge(r),this.#he(o),this.#L.forgetWaivers(),this.#z(),this.#K(),this.#G={},this.#W(!1),this.#Z(0),this.#f.adoptActiveThread(),this.#f.rehydrate(),this.#f.refreshDrawer()}#he(e){let n=this.#S.rescopeStore(e);n!==null&&(this.conversationStore=n,this.#ue())}#pe(){let e=this.getAttribute("theme")==="dark";this.#A.replaceChildren(Ms("theme","theme-icon",e?hd:ud,null))}openThreads(){this.#f.openThreads()}openCheckpoints(){this.#f.openCheckpoints()}closeThreads(){this.#g.close()}closeCheckpoints(){this.#w.close()}toggleCheckpoints(){if(this.#w.open_){this.#w.close();return}this.openCheckpoints()}newChat(){this.#z(),this.#f.reapUnsent(),this.#K(),this.#f.startThread(),this.#W(!1),this.#Z(0),this.collapsed||this.#l.focus({preventScroll:!0})}#K(){this.#H=null,this.#J.detach(),this.#fe(),this.#f.forgetRestored(),this.#$.length=0,this.#U=null}#fe(){this.#ae.end(),this.#v.releaseTurn(),this.#n.clear(),this.#v.forgetCards(),this.#o.clearBlocks(),this.#r.forget(),this.#C.tray?.clear(),this.removeAttribute("data-composer-settling"),this.removeAttribute("data-restoring"),this.#v.empty()}async retryLastTurn(){if(this.#P)return!1;let e=this.#ie(),n=e.truncateToLastUser();if(n===null)return!1;this.#fe();for(let r of n)this.#f.replay(r);return await e.resume(),!0}appendMessage(e,n){return this.#v.append(e,n)}#_e(){this.#u.className="chat",this.#u.setAttribute("part","panel");let e=document.createElement("div");e.className="header",e.setAttribute("part","header");let n=this.#m;n.className="header-title",n.setAttribute("part","title"),n.textContent=this.getAttribute("title-text")??this.#t.title,(this.querySelector('[slot="icon"]')!==null||this.getAttribute("data-icon-url")!==null)&&e.append(Ms("icon","icon",null,this.getAttribute("data-icon-url")));let r=document.createElement("slot");r.name="header-actions";let o=document.createElement("div");o.className="header-controls",o.setAttribute("part","header-controls");let i=Vr("history",this.#t.chatHistory,"\u2630");i.addEventListener("click",()=>this.openThreads());let s=Vr("checkpoints",this.#t.checkpoints,"\u21BA");s.addEventListener("click",()=>this.toggleCheckpoints());let a=Vr("new",this.#t.newChat,"\u271A");a.addEventListener("click",()=>this.newChat());let l=Vr("collapse",this.#t.collapse,"\u2014");l.addEventListener("click",()=>this.toggleCollapsed()),this.#f.runs()!==null?o.append(i,s,a):o.append(i,a),this.getAttribute("data-theme-toggle")!==null&&(this.#A.type="button",this.#A.className="header-btn header-btn--theme",this.#A.setAttribute("part","header-button theme-toggle"),this.#A.title=this.#t.toggleTheme,this.#A.setAttribute("aria-label",this.#t.toggleTheme),this.#A.addEventListener("click",()=>this.toggleTheme()),this.#pe(),o.append(this.#A)),o.append(l),e.append(n,r,o),this.#T.enablePanelDrag(e),this.#p.className="messages",this.#p.setAttribute("part","messages"),this.#p.setAttribute("role","log"),this.#p.setAttribute("aria-live","off"),this.#p.setAttribute("aria-label",this.#t.conversation),this.#a.className="jump-latest",this.#a.type="button",this.#a.setAttribute("part","jump-latest"),this.#a.textContent=this.#t.jumpToLatest,this.#c.mount(),this.#v.mountScroller(this.#a),this.#s.mount(),this.#I.className="empty",this.#I.setAttribute("part","empty");let c=document.createElement("div");c.className="greeting",c.setAttribute("part","greeting");let u=document.createElement("slot");u.name="greeting",u.append(this.#se),c.append(u),this.#le(),this.#I.append(c);let m=document.createElement("slot");m.name="empty";let w=Qp(this,this.#t,_=>{this.sendMessage(_)});w!==null&&m.append(w),this.#I.append(m),this.#O.className="queued",this.#O.setAttribute("part","queued"),this.#O.setAttribute("role","group"),this.#O.setAttribute("aria-label",this.#t.queued),this.#O.hidden=!0,this.#p.append(this.#I),this.#v.updateEmptyState();let p=document.createElement("div");p.className="input-row",p.setAttribute("part","composer");let h=document.createElement("div");h.className="composer",h.setAttribute("part","composer-surface");let v=document.createElement("div");v.className="composer-tools",v.setAttribute("part","composer-tools"),this.#l.className="input",this.#l.setAttribute("part","input"),this.#l.setAttribute("aria-label",this.#t.message),this.#l.rows=1,this.#l.placeholder=this.#t.inputPlaceholder,this.#l.addEventListener("keydown",_=>this.#Ae(_)),this.#l.addEventListener("input",()=>this.#ge()),this.#h.className="send",this.#h.type="button",this.#h.setAttribute("part","send"),this.#h.append(Os("icon-send","send-send",ad),Os("icon-stop","send-stop",ld)),this.#h.title=this.#t.send,this.#h.setAttribute("aria-label",this.#t.send),this.#h.dataset.state="idle",this.#h.addEventListener("click",()=>{if(this.#P){this.#z();return}this.#oe()}),this.#y.className="skill-hint",this.#y.setAttribute("part","skill-hint"),this.#y.hidden=!0,this.#x.className="attach-btn",this.#x.type="button",this.#x.setAttribute("part","attach-button"),this.#x.append(Os("icon-attach","attach-glyph",cd)),this.#x.title=this.#t.attachFiles,this.#x.setAttribute("aria-label",this.#t.attachFiles),this.#x.hidden=!0,this.#x.addEventListener("click",()=>this.#_.click()),this.#_.className="attach-input",this.#_.type="file",this.#_.multiple=!0,this.#_.hidden=!0,this.#_.addEventListener("change",()=>this.#C.onFilesPicked()),this.#M.className="attachment-slot",this.#X.className="voice-slot";let x=document.createElement("slot");x.name="footer",v.append(this.#x,this.#X,this.#h),h.append(this.#l,v),p.append(h,this.#_),this.#d.className="messages-wrap",this.#d.append(this.#p,this.#a,this.#c.button),this.#u.append(e,this.#d,this.#b.palette,this.#b.chips,this.#y,this.#O,this.#M,p,x,this.#g.element,this.#w.element),this.#u.addEventListener("pointerdown",_=>{if(!this.#w.open_)return;let L=_.composedPath();L.includes(this.#w.element)||L.includes(s)||this.#w.close()}),this.#E.className="launcher",this.#E.type="button",this.#E.setAttribute("part","launcher"),this.#E.setAttribute("aria-label",this.#t.expand),this.#k.className="launcher-badge",this.#k.setAttribute("part","launcher-badge"),this.#k.setAttribute("aria-hidden","true"),this.#k.hidden=!0,this.#N.className="rail-label",this.#N.setAttribute("part","rail-label"),this.#N.setAttribute("aria-hidden","true"),this.#N.textContent=this.getAttribute("title-text")??this.#t.title,this.#E.append(Ms("launcher","launcher-icon",pd,ip(this)),this.#N,this.#k),this.#E.addEventListener("click",()=>this.setCollapsed(!1)),this.#T.enableLauncherDrag(),this.#T.mountResizeGrips(this.#u),rp(this.#i);let S=this.#T.probe;S.className="viewport-probe",S.setAttribute("aria-hidden","true"),this.#i.append(S,this.#s.region,this.#u,this.#E)}#me(){this.#E.setAttribute("aria-expanded",String(!this.collapsed));let e=this.#F;this.#k.textContent=e>9?"9+":String(e),this.#k.hidden=e===0||!op(this);let n=this.#k.hidden?this.#t.expand:oe(this.#t.expandUnread,{count:e});this.#E.setAttribute("aria-label",n),this.#E.title=n}#Z(e){this.#F=e,this.#me(),this.dispatchEvent(new CustomEvent(xa,{detail:{unread:e},bubbles:!0,composed:!0}))}#Se(){this.collapsed&&this.#Z(this.#F+1)}#ge(){this.#b.onInput(this.#l.value),this.#y.hidden=!0,Ut(this.#l),this.#U=null}#Ae(e){if(this.#b.onKeydown(e)){e.preventDefault();return}if(e.key==="Escape"&&this.#P){e.preventDefault(),this.#z();return}if(e.key==="Enter"&&!e.shiftKey){e.preventDefault(),this.#oe();return}this.#ke(e)}#ke(e){let n=e.key==="ArrowUp";if(!n&&e.key!=="ArrowDown"||this.#b.isOpen())return;let r=this.#$;if(r.length===0||this.#U===null&&(!n||this.#l.value!==""))return;let o=this.#U===null?0:this.#U+(n?1:-1);o>=r.length||(e.preventDefault(),this.#U=o<0?null:o,this.#l.value=o<0?"":r[o],this.#l.setSelectionRange(this.#l.value.length,this.#l.value.length),Ut(this.#l))}#z(){for(let e of this.#D)this.#$[0]!==e&&this.#$.unshift(e);this.#D.length=0,this.#Q(),this.#te.abort(),this.#H?.cancel(),this.#f.stopContinuation()}#W(e){let n=this.#P&&!e;this.#P=e;let r=e?this.#t.stop:this.#t.send;this.#h.title=r,this.#h.setAttribute("aria-label",r),this.#h.dataset.state=e?"running":"idle",n&&this.#Re()}#Re(){let e=this.#D.shift();this.#Q(),e!==void 0&&this.sendMessage(e)}#Q(){this.#O.replaceChildren(),this.#O.hidden=this.#D.length===0;for(let[e,n]of this.#D.entries()){let r=document.createElement("button");r.type="button",r.className="queued-chip",r.setAttribute("part","queued-chip"),r.textContent=n,r.title=oe(this.#t.removeQueued,{text:n}),r.setAttribute("aria-label",r.title),r.addEventListener("click",()=>{this.#D.splice(e,1),this.#Q()}),this.#O.appendChild(r)}}async#oe(){let e=this.#l.value.trim(),n=this.#C.tray?.readyRefs()??[];if(!(e===""&&n.length===0)){if(this.#P){e!==""&&(this.#D.push(e),this.#Q(),this.#l.value="",Ut(this.#l));return}e!==""&&this.#$[0]!==e&&this.#$.unshift(e),this.#U=null,this.#l.value="",Ut(this.#l),this.#C.tray?.hasPending()===!0&&this.#v.appendNotice("\u{1F4CE}",oe(this.#t.attachmentsStillUploading,{n:this.#C.tray.pendingCount()}),"attachment-pending"),this.#C.tray?.clearReady(),await this.sendMessage(e,n)}}async sendMessage(e,n=[]){if(this.#P||e===""&&n.length===0)return;this.#v.isEmpty()&&this.setAttribute("data-composer-settling","");let r=this.appendMessage(Le.USER,e);n.length>0&&r.appendChild(fs(n)),this.dispatchEvent(new CustomEvent(ya,{detail:{content:e,attachments:n},bubbles:!0,composed:!0})),await this.#Ie(e,n)}attachFile(e){return this.#C.attach(e)}async#Ie(e,n){if(this.endpoint===""){console.error('<ag-ui-chat>: no endpoint is set, so this message was not sent and no request was made. Point the element at your AG-UI mount with the endpoint attribute (endpoint="/agent/"), or assign chat.endpoint before sending.'),this.#v.appendNotice("\u26A0",this.#t.notConnected,"not-connected");return}await this.#ie().send(e,n)}#ie(){return this.#H===null&&(this.#H=this.#ve({endpoint:this.endpoint,initialMessages:this.#f.restored,persist:!0})),this.#H}#ve(e){let n=this.#f.threadId,r=this.agentFactory({endpoint:e.endpoint,headers:this.#ne(),getHeaders:()=>this.#ne(),trustedOrigins:this.trustedOrigins,...this.#re(),threadId:n,initialMessages:e.initialMessages,initialState:this.#G});return new no({agent:r,handlers:this.#J.forClient(),getTools:()=>this.#R.advertise(),getContext:()=>this.#L.buildContext(),executeTool:o=>this.#L.execute(o),resolveInterrupts:o=>this.#L.resolveInterrupts(o),...e.persist?{onPersist:o=>this.conversationStore.saveMessages(n,o)}:{},onStateChanged:o=>this.#Ce(o),connectionLostMessage:this.#t.connectionLost,unfinishedMessage:this.#t.callNotFinished,declinedMessage:this.#t.declinedAction,maxToolRounds:cf(this)})}#Ce(e){this.#G={...e},this.dispatchEvent(new CustomEvent(Ea,{detail:{state:this.#G},bubbles:!0,composed:!0}))}#be(e,n){this.#v.appendNotice("\u2922",e,"surface",n===null?void 0:{label:this.#t.undo,onActivate:n})}enableCharts(e=["tool","activity"]){let n=!this.#o.has(_o)&&!this.#R.has(ps);e.includes("activity")&&this.registerActivityRenderer({type:_o,render:r=>{let o=or(r);return o===null?null:Lr(o)},removedNotice:this.#t.chartUndrawable}),e.includes("tool")&&this.registerTool(zh()),n&&this.isConnected&&this.reload()}registerActivityRenderer(e){this.#o.register(e)}get unhandledActivityTypes(){return this.#o.unhandledTypes()}};function VE(t){let e=t?.removed;return typeof e=="number"?e:null}function qE(){customElements.get(xo)===void 0&&customElements.define(xo,so)}async function WE(t,e,n={}){await wt(t),await za(t,{...n,flashMs:n.flashMs??0}),await Ha(t,e,n)}async function XE(t,e={}){await wt(t),await Ga(t,e)}async function YE(t,e={}){await wt(t),await Fa(t,e)}async function KE(t,e,n={}){await wt(t),await $a(t,e,n)}async function ZE(t,e,n={}){await wt(t),await Ba(t,e,n)}function QE(t,e){t instanceof HTMLInputElement&&t.type==="checkbox"?vr(t,!!e):qt(t,String(e)),t.dispatchEvent(new Event("input",{bubbles:!0})),t.dispatchEvent(new Event("change",{bubbles:!0}))}var JE="0.39.0";export{Ta as ATTACHMENT_EVENT,so as AgUiChat,no as AgUiClient,_o as CHART_ACTIVITY_TYPE,ps as CHART_TOOL_NAME,ko as CHAT_CORNERS,Na as COMPACTION_ACTIVITY_TYPE,Sa as CUSTOM_AGENT_EVENT,Ur as CheckpointMenu,gr as ClientToolRegistry,Zs as ConnectionLostError,le as DEFAULT_UI_STRINGS,xo as ELEMENT_TAG,ka as FEEDBACK_EVENT,Ia as INVALIDATE_CUSTOM_NAME,Aa as INVALIDATE_EVENT,Oa as LOAD_CAPABILITY_TOOL,cw as MAX_QUOTE_CHARS,OE as MAX_SUGGESTIONS,ME as MAX_SUGGESTION_CHARS,Mn as MAX_TOOL_ROUNDS,jt as MESSAGE_ACTIONS,Le as MESSAGE_ROLE,yr as PAGE_ACTIONS,_a as RUN_FINISHED_EVENT,io as RemoteConversationStore,Hr as RunIndex,Ea as STATE_EVENT,ya as SUBMIT_EVENT,Ra as SUGGESTIONS_ACTIVITY_TYPE,Xe as SessionStorageStore,wa as TOGGLE_EVENT,te as TOOL_CALL_STATUS,Ln as TOOL_DISPLAY,Pe as TOOL_OUTCOME,jr as ToolCallCard,xa as UNREAD_EVENT,JE as VERSION,Eo as X_CONFIRM_KEY,fr as X_DESTRUCTIVE_KEY,mr as X_NAVIGATES_KEY,xe as X_SUMMARY_KEY,ql as asQuote,nc as attachMessageActions,Xl as attachQuoteOffer,or as chartSpecFrom,XE as clickElement,La as createChatSurfaceTools,Sc as createHttpAgent,ja as createPageActionTools,Va as createPageMapContext,No as createPageStateTools,qa as createRouteTools,um as createStateHookTools,qE as defineAgUiChat,WE as fillField,sm as flash,za as focusWithFlash,Ga as highlightThenClick,Sd as isChatCorner,Fl as isDestructive,us as isNavigates,Pl as mergeUiStrings,Ps as messageActionBar,Kl as messageAttachments,Ul as parseToolCatalog,Io as prefersReducedMotion,YE as pressButton,Fa as pressThenClick,Tc as prettifyToolName,Pr as quotableSelection,Dr as relativeTime,Lr as renderChart,eo as renderMarkdown,to as renderSuggestionChips,Hl as requestApproval,zl as requestConfirmation,Dl as requestQuestion,wt as scrollIntoCenterView,KE as selectControl,$a as selectOption,QE as setControlValue,vr as setNativeChecked,qt as setNativeValue,Pa as showHighlightOverlay,Zp as suggestionPrompts,ZE as toggleCheckbox,Ba as toggleControl,Gr as toolStatusFromOutcome,Vl as transcribeAudio,Ha as typeInto,Bl as uploadAttachment};
