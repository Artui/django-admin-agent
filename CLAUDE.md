...
`django-ag-ui` is resolved from PyPI via the `django-ag-ui>=0.65` floor in
...
| django-ag-ui | 0.65 | from PyPI (`>=0.65`, no ceiling) |
| django-pydantic-agent | 0.26 | from PyPI (`>=0.26`, no ceiling) |
